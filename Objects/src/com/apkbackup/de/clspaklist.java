...
public class clspaklist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.apkbackup.de.clspaklist");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.apkbackup.de.clspaklist.class).invoke(this, new Object[] {null});
        else
...
com.tchart.materialcolors.MaterialColors _mcl = null;
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _cdh = null;
 ...
 //BA.debugLineNum = 236;BA.debugLine="Dim mcl As MaterialColors";
...
_cdh = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 240;BA.debugLine="cdH.Initialize(Colors.Transparent, 0)";
...
_lblb.setText(BA.ObjectToCharSequence("   "+_text));
 //BA.debugLineNum = 243;BA.debugLine="lblB.TextColor = mcl.md_black_1000";
_lblb.setTextColor(_mcl.getmd_black_1000());
 //BA.debugLineNum = 244;BA.debugLine="lblB.TextSize = 16";
_lblb.setTextSize((float) (16));
 //BA.debugLineNum = 245;BA.debugLine="lblB.Typeface = Typeface.LoadFromAssets(\"OpenSans";
_lblb.setTypeface(__c.Typeface.LoadFromAssets("OpenSans.ttf"));
 //BA.debugLineNum = 246;BA.debugLine="lblB.Gravity = Gravity.CENTER_HORIZONTAL";
_lblb.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 247;BA.debugLine="pnlH.AddView(lblB, 0, 0, 100%x, 30dip)";
_pnlh.AddView((android.view.View)(_lblb.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 248;BA.debugLine="AddToSV(pnlH, 35dip, False)";
_addtosv(_pnlh,__c.DipToCurrent((int) (35)),__c.False);
...
_pnl.setVisible(__c.True);
 ...
 //BA.debugLineNum = 1256;BA.debugLine="If FirstPos > -1 Then MoveTopAfterFiltering(First";
if (_firstpos>-1) { 
...
_pnl = _findpanelcontaining((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_chb.getObject())));
 //BA.debugLineNum = 1158;BA.debugLine="PaintBackground(pnl, HasExtraContent And Extended";
...
if ((_sub_check).equals("") == false) { 
 //BA.debugLineNum = 1161;BA.debugLine="If SubExists(CallbackMod, sub_Check) Then CallSu";
...
int _p = 0;
 ...
 //BA.debugLineNum = 841;BA.debugLine="BlockCheckEvent = True 'We don't want to trigger";
_blockcheckevent = __c.True;
...
_paint_pressed = (int) (4);
 //BA.debugLineNum = 37;BA.debugLine="Type typSortData(Index As Int, Value As Object)";
;
...
_sv.getPanel().setHeight(_svheight);
 //BA.debugLineNum = 999;BA.debugLine="For i = ExtensionIndex + 1 To sv.Panel.NumberOfV";
{
final int step16 = 1;
...
_newposition = (int) (__c.Max(0,_newposition-__c.DipToCurrent((int) (5))));
 //BA.debugLineNum = 741;BA.debugLine="Dim PreviousPosition As Int: PreviousPosition = -";
_previousposition = 0;
 //BA.debugLineNum = 741;BA.debugLine="Dim PreviousPosition As Int: PreviousPosition = -";
...
int _newposition = 0;
 //BA.debugLineNum = 932;BA.debugLine="Public Sub ExtendItem(ItemID As Object, AddedConte";
...
_pnldivider = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 951;BA.debugLine="pnlDivider = pnl.GetView(pnl.NumberOfViews -";
_pnldivider.setObject((android.view.ViewGroup)(_pnl.GetView((int) (_pnl.getNumberOfViews()-1)).getObject()));
 //BA.debugLineNum = 952;BA.debugLine="pnlDivider.Top = pnl.Height + ContentHeight -";
...
if (_ischeckbox(_pnl.GetView((int) (0)))) { 
 //BA.debugLineNum = 956;BA.debugLine="pnl.AddView(AddedContent, ChkBoxSize, pnl.Hei";
_pnl.AddView((android.view.View)(_addedcontent.getObject()),_chkboxsize,(int) (_pnl.getHeight()-_dividersize),(int) ((double)(Double.parseDouble(_getwidth()))-_chkboxsize),_contentheight);
 ...
 //BA.debugLineNum = 958;BA.debugLine="pnl.AddView(AddedContent, 0, pnl.Height - Div";
...
_contentbottom = (int) (_pnl.getTop()+_pnl.getHeight());
 //BA.debugLineNum = 966;BA.debugLine="If ContentBottom > sv.ScrollPosition + getHeig";
...
__c.DoEvents();
 //BA.debugLineNum = 970;BA.debugLine="NewPosition = sv.ScrollPosition + Min(Content";
...
anywheresoftware.b4a.objects.PanelWrapper _pnl = null;
int _i = 0;
 //BA.debugLineNum = 1187;BA.debugLine="Private Sub Filter(ViewIndexInPanel As Int, Compar";
 //BA.debugLineNum = 1192;BA.debugLine="If Not(SubExists(CallbackMod, ComparisonFunction)";
...
if (_filtertype==0) { 
 //BA.debugLineNum = 1198;BA.debugLine="L = CreateTagList(ViewIndexInPanel, 0, NumberOfI";
_l = _createtaglist(_viewindexinpanel,(int) (0),(int) ((double)(Double.parseDouble(_numberofitems()))-1));
 }else {
 //BA.debugLineNum = 1200;BA.debugLine="L = CreateTextList(ViewIndexInPanel, 0, NumberOf";
...
_pnl.setObject((android.view.ViewGroup)(_sv.getPanel().GetView(_i).getObject()));
 //BA.debugLineNum = 1208;BA.debugLine="CallSub3(CallbackMod, ComparisonFunction, pnl.Ta";
...
_pnl.setVisible(__c.False);
 ...
 //BA.debugLineNum = 1220;BA.debugLine="If FirstPos > -1 Then MoveTopAfterFiltering(First";
if (_firstpos>-1) { 
_movetopafterfiltering(_firstpos);};
...
public int  _filtertag(int _viewindexinpanel,String _comparisonfunction) throws Exception{
 //BA.debugLineNum = 1228;BA.debugLine="Public Sub FilterTag(ViewIndexInPanel As Int, Comp";
 //BA.debugLineNum = 1229;BA.debugLine="Return Filter(ViewIndexInPanel, ComparisonFunctio";
...
public int  _filtertext(int _viewindexinpanel,String _comparisonfunction) throws Exception{
 //BA.debugLineNum = 1236;BA.debugLine="Public Sub FilterText(ViewIndexInPanel As Int, Com";
 //BA.debugLineNum = 1237;BA.debugLine="Return Filter(ViewIndexInPanel, ComparisonFunctio";
...
public boolean  _ischeckbox(anywheresoftware.b4a.objects.ConcreteViewWrapper _myview) throws Exception{
 ...
 //BA.debugLineNum = 800;BA.debugLine="Return (GetType(MyView) = \"android.widget.CheckBo";
...
anywheresoftware.b4a.objects.PanelWrapper _pnl = null;
 //BA.debugLineNum = 753;BA.debugLine="Public Sub JumpToPosition(Position As Int) As Pane";
...
int _p = 0;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _chk = null;
 //BA.debugLineNum = 803;BA.debugLine="Private Sub MakeCheckedList(ListType As Int) As Li";
...
int _i = 0;
 ...
 //BA.debugLineNum = 1071;BA.debugLine="DragAndDrop.Top = Min(Max(0, DragAndDrop.Top + Y";
_draganddrop.setTop((int) (__c.Min(__c.Max(0,_draganddrop.getTop()+_y-_lasty),_sv.getPanel().getHeight()-_draganddrop.getHeight())));
...
if (true) break;};
 ...
 //BA.debugLineNum = 1084;BA.debugLine="If DragAndDrop.Top >= pnl.Top And DragAndDrop.To";
...
_moveitem(_startposition,_endposition);
 //BA.debugLineNum = 1092;BA.debugLine="If EndPosition > StartPosition Then EndPosition =";
if (_endposition>_startposition) { 
_endposition = (int) (_endposition-1);};
 //BA.debugLineNum = 1093;BA.debugLine="If SubExists(CallbackMod, sub_AfterDrop) Then Cal";
...
int _p = 0;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _chk = null;
 //BA.debugLineNum = 894;BA.debugLine="Private Sub PaintBackground(pnl As Panel, Extended";
...
_chk.setObject((android.widget.CheckBox)(_pnl.GetView(_p).getObject()));
 //BA.debugLineNum = 905;BA.debugLine="If chk.Checked Then State = State + PAINT_CHECK";
if (_chk.getChecked()) { 
...
anywheresoftware.b4a.objects.PanelWrapper _pnl = null;
 //BA.debugLineNum = 1140;BA.debugLine="Private Sub pnlSV_Click(ViewTag As Object) As Bool";
...
_pnl.setObject((android.view.ViewGroup)(__c.Sender(ba)));
 //BA.debugLineNum = 1143;BA.debugLine="If SubExists(CallbackMod, sub_Click) Then CallSub";
...
anywheresoftware.b4a.objects.PanelWrapper _pnl = null;
 //BA.debugLineNum = 1147;BA.debugLine="Private Sub pnlSV_LongClick(ViewTag As Object) As";
 //BA.debugLineNum = 1148;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1149;BA.debugLine="pnl = Sender";
_pnl.setObject((android.view.ViewGroup)(__c.Sender(ba)));
 //BA.debugLineNum = 1150;BA.debugLine="If SubExists(CallbackMod, sub_LongClick) Then Cal";
...
int _p = 0;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _chb = null;
 //BA.debugLineNum = 1101;BA.debugLine="Private Sub pnlSV_Touch(ViewTag As Object, Action";
...
if (__c.SubExists(ba,_callbackmod,_sub_paint)) { 
 //BA.debugLineNum = 1114;BA.debugLine="CallSub3(CallbackMod, sub_Paint, pnl, PAINT_PRE";
...
_extended = false;
 //BA.debugLineNum = 861;BA.debugLine="Extended = HasExtraContent And ExtendedItemID = p";
...
if (_extended) { 
 //BA.debugLineNum = 866;BA.debugLine="pnlDivider = pnlItem.GetView(pnlItem.NumberOfVi";
_pnldivider.setObject((android.view.ViewGroup)(_pnlitem.GetView((int) (_pnlitem.getNumberOfViews()-2)).getObject()));
 }else {
 //BA.debugLineNum = 868;BA.debugLine="pnlDivider = pnlItem.GetView(pnlItem.NumberOfVi";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1030;BA.debugLine="Public Sub StartDragAndDrop(pnl As Panel, subAfter";
...
_draganddropshadow.Initialize(ba,"");
 //BA.debugLineNum = 1034;BA.debugLine="DragAndDropShadow.Color =Colors.ARGB(240,3,169,2";
_draganddropshadow.setColor(__c.Colors.ARGB((int) (240),(int) (3),(int) (169),(int) (244)));
 //BA.debugLineNum = 1035;BA.debugLine="sv.Panel.AddView(DragAndDropShadow, pnl.Left, pn";
...
_draganddrop.SetBackgroundImage((android.graphics.Bitmap)(_viewtobmp((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_pnl.getObject()))).getObject()));
 //BA.debugLineNum = 1038;BA.debugLine="sv.Panel.AddView(DragAndDrop, pnl.Left, pnl.Top,";
