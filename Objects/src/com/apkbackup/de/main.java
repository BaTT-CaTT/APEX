...
public static anywheresoftware.b4a.objects.Timer _zipex = null;
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 855;BA.debugLine="Sub ab1_Click";
 //BA.debugLineNum = 856;BA.debugLine="Dim fname,version As String";
_fname = "";
_version = "";
 //BA.debugLineNum = 857;BA.debugLine="Dim cont As Label";
_cont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 858;BA.debugLine="cont.Initialize(\"\")";
_cont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 859;BA.debugLine="Bname.Enabled=True";
mostCurrent._bname.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 860;BA.debugLine="Bpath.Enabled=True";
mostCurrent._bpath.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 862;BA.debugLine="Bname.TextColor=mcl.md_light_blue_400";
mostCurrent._bname.setTextColor(mostCurrent._mcl.getmd_light_blue_400());
 //BA.debugLineNum = 863;BA.debugLine="Bpath.Gravity=Gravity.CENTER_HORIZONTAL";
mostCurrent._bpath.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 864;BA.debugLine="Bname.Text=pak.GetApplicationLabel(finish.Get(0))";
mostCurrent._bname.setText(BA.ObjectToCharSequence(_pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))));
 //BA.debugLineNum = 865;BA.debugLine="fname=pak.GetApplicationLabel(finish.Get(0))";
_fname = _pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._finish.Get((int) (0))));
 //BA.debugLineNum = 866;BA.debugLine="version=pak.GetVersionName(finish.Get(0))";
_version = _pak.GetVersionName(BA.ObjectToString(mostCurrent._finish.Get((int) (0))));
 //BA.debugLineNum = 867;BA.debugLine="Bpath.Text=datas.GetSimple(\"0\")";
mostCurrent._bpath.setText(BA.ObjectToCharSequence(mostCurrent._datas._getsimple("0")));
 //BA.debugLineNum = 868;BA.debugLine="cont.Text=\"Backup \"&Bname.Text&\" ?\"";
_cont.setText(BA.ObjectToCharSequence("Backup "+mostCurrent._bname.getText()+" ?"));
 //BA.debugLineNum = 869;BA.debugLine="icon=pak.GetApplicationIcon(finish.Get(0))";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))));
 //BA.debugLineNum = 870;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 871;BA.debugLine="Builder.Initialize(\"stadia\")";
_builder.Initialize(mostCurrent.activityBA,"stadia");
 //BA.debugLineNum = 872;BA.debugLine="Builder.Title(\"Backup App:\").TitleColor(mcl.md_bl";
_builder.Title(BA.ObjectToCharSequence("Backup App:")).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_cont.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Start")).PositiveColor(mostCurrent._mcl.getmd_black_1000()).NeutralText(BA.ObjectToCharSequence("Cancel")).NeutralColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray).ItemsColor(mostCurrent._mcl.getmd_blue_400()).ItemsGravity(_builder.GRAVITY_START).MaxIconSize(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (64))).ItemsCallbackSingleChoice((int) (3)).AlwaysCallSingleChoiceCallback();
 //BA.debugLineNum = 873;BA.debugLine="Builder.Items(Array As String (fname,\"Ver. \"&vers";
_builder.Items((java.lang.CharSequence[])(new String[]{_fname,"Ver. "+_version,"Folder:"+mostCurrent._bpath.getText()}));
 //BA.debugLineNum = 874;BA.debugLine="Builder.ItemsCallback";
_builder.ItemsCallback();
 //BA.debugLineNum = 875;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 876;BA.debugLine="deldia.Show";
...
public static String  _acp_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 438;BA.debugLine="Sub acp_ItemClick (Position As Int, Value As Objec";
 //BA.debugLineNum = 439;BA.debugLine="Select Position";
switch (_position) {
case 0: {
 //BA.debugLineNum = 441;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 442;BA.debugLine="path_explorer";
_path_explorer();
 break; }
case 1: {
 //BA.debugLineNum = 444;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 445;BA.debugLine="ToastMessageShow(\"Select case 1\",False)";
...
public static String  _acs_oncheckedchanged(Object _tag,boolean _checked) throws Exception{
 //BA.debugLineNum = 448;BA.debugLine="Sub acs_onCheckedChanged(tag As Object, checked As";
 //BA.debugLineNum = 449;BA.debugLine="Select checked";
...
case 0: {
 //BA.debugLineNum = 451;BA.debugLine="StartService(fileobserve)";
anywheresoftware.b4a.keywords.Common.StartService(processBA,(Object)(mostCurrent._fileobserve.getObject()));
 //BA.debugLineNum = 452;BA.debugLine="ToastMessageShow(\"File Service Start..\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("File Service Start.."),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 1: {
 //BA.debugLineNum = 454;BA.debugLine="StopService(fileobserve)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._fileobserve.getObject()));
 //BA.debugLineNum = 455;BA.debugLine="ToastMessageShow(\"File Service stop!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("File Service stop!"),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
_dex.Initialize(processBA,"dex",(long) (1000));
 //BA.debugLineNum = 231;BA.debugLine="zipex.Initialize(\"zipex\",1000)";
_zipex.Initialize(processBA,"zipex",(long) (1000));
 //BA.debugLineNum = 232;BA.debugLine="dex.Enabled=False";
_dex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 233;BA.debugLine="exa.Enabled=False";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 234;BA.debugLine="ex.Interval=40";
_ex.setInterval((long) (40));
 //BA.debugLineNum = 235;BA.debugLine="dex.Interval=40";
_dex.setInterval((long) (40));
 //BA.debugLineNum = 236;BA.debugLine="zipex.Interval=40";
_zipex.setInterval((long) (40));
 //BA.debugLineNum = 237;BA.debugLine="exa.Interval=1";
_exa.setInterval((long) (1));
 //BA.debugLineNum = 238;BA.debugLine="tcount=0";
_tcount = (int) (0);
 //BA.debugLineNum = 239;BA.debugLine="ex.Enabled=False";
_ex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 240;BA.debugLine="zipex.Enabled=False";
_zipex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 241;BA.debugLine="pn.Initialize";
mostCurrent._pn.Initialize();
 //BA.debugLineNum = 243;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 244;BA.debugLine="File.MakeDir(File.DirRootExternal,\"/APEX/backups";
...
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._paths.GetKeyAt(_i))+"="+BA.ObjectToString(mostCurrent._paths.GetValueAt(_i)));
 ...
 //BA.debugLineNum = 256;BA.debugLine="Dim de As String = File.DirRootExternal";
...
anywheresoftware.b4a.keywords.Common.Log("DirRootExternal = "+_de);
 //BA.debugLineNum = 258;BA.debugLine="Dim mtc As Matcher = Regex.Matcher(\"(/|\\\\)[^(/|\\\\";
_mtc = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
_mtc = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(/|\\\\)[^(/|\\\\)]*(/|\\\\)",_de);
 //BA.debugLineNum = 259;BA.debugLine="Dim extsdcard As String = de";
_extsdcard = _de;
 //BA.debugLineNum = 260;BA.debugLine="If mtc.Find = True Then";
if (_mtc.Find()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 261;BA.debugLine="Dim mnt As String = mtc.Group(0)";
_mnt = _mtc.Group((int) (0));
 //BA.debugLineNum = 263;BA.debugLine="Log (\"mount point = \"& mnt)";
anywheresoftware.b4a.keywords.Common.Log("mount point = "+_mnt);
 //BA.debugLineNum = 264;BA.debugLine="Dim dirs As List = File.ListFiles(mnt)";
_dirs = new anywheresoftware.b4a.objects.collections.List();
_dirs = anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt);
 //BA.debugLineNum = 265;BA.debugLine="For Each f As String In dirs";
{
final anywheresoftware.b4a.BA.IterableList group154 = _dirs;
final int groupLen154 = group154.getSize()
;int index154 = 0;
;
for (; index154 < groupLen154;index154++){
_f = BA.ObjectToString(group154.Get(index154));
 //BA.debugLineNum = 266;BA.debugLine="If storage.isExternalStorageRemovable(mnt&f) Th";
if (mostCurrent._storage.isExternalStorageRemovable(_mnt+_f)) { 
 //BA.debugLineNum = 267;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is removable\")";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is removable");
 //BA.debugLineNum = 268;BA.debugLine="If File.ListFiles(mnt&f).IsInitialized Then";
if (anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt+_f).IsInitialized()) { 
 //BA.debugLineNum = 269;BA.debugLine="Log(\"probably ExtSDCard: \"&mnt&f)";
anywheresoftware.b4a.keywords.Common.Log("probably ExtSDCard: "+_mnt+_f);
 //BA.debugLineNum = 270;BA.debugLine="extsdcard = mnt&f";
_extsdcard = _mnt+_f;
 //BA.debugLineNum = 271;BA.debugLine="datas.DeleteAll";
mostCurrent._datas._deleteall();
 //BA.debugLineNum = 272;BA.debugLine="datas.PutSimple(\"0\",mnt&f&\"/APEX/backups\")";
mostCurrent._datas._putsimple("0",(Object)(_mnt+_f+"/APEX/backups"));
 }else {
 };
 }else {
 //BA.debugLineNum = 277;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is NOT removab";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is NOT removable");
 };
 }
};
 };
 //BA.debugLineNum = 281;BA.debugLine="Log(\"extsdcard=\"&extsdcard)";
anywheresoftware.b4a.keywords.Common.Log("extsdcard="+_extsdcard);
 //BA.debugLineNum = 284;BA.debugLine="file_check";
_file_check();
 //BA.debugLineNum = 285;BA.debugLine="apps_start";
_apps_start();
...
de.amberhome.objects.appcompat.ACMenuItemWrapper _item3 = null;
 //BA.debugLineNum = 307;BA.debugLine="Sub Activity_CreateMenu(menu As ACMenu)";
 //BA.debugLineNum = 308;BA.debugLine="Dim eim As BitmapDrawable";
_eim = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 309;BA.debugLine="eim.Initialize(LoadBitmap(File.DirAssets,\"ic_exit";
_eim.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_exit_to_app_white_48dp.png").getObject()));
 //BA.debugLineNum = 310;BA.debugLine="Dim fim1,climg1 As BitmapDrawable";
...
_climg1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 311;BA.debugLine="fim1.Initialize(LoadBitmap(File.DirAssets,\"ic_set";
_fim1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_settings_applications_white_36dp.png").getObject()));
 //BA.debugLineNum = 312;BA.debugLine="climg1.Initialize(LoadBitmap(File.DirAssets,\"ic_a";
_climg1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_apps_white_36dp.png").getObject()));
 //BA.debugLineNum = 313;BA.debugLine="menu.Clear";
_menu.Clear();
 //BA.debugLineNum = 314;BA.debugLine="Dim item,item2,item3 As ACMenuItem";
...
_item3 = new de.amberhome.objects.appcompat.ACMenuItemWrapper();
 //BA.debugLineNum = 315;BA.debugLine="item3=toolbar.Menu.Add2(0, 0, \"Menu\", climg1)";
_item3 = mostCurrent._toolbar.getMenu().Add2((int) (0),(int) (0),BA.ObjectToCharSequence("Menu"),(android.graphics.drawable.Drawable)(_climg1.getObject()));
 //BA.debugLineNum = 316;BA.debugLine="item=toolbar.Menu.Add2(1, 1, \"SMenu\", fim1)";
_item = mostCurrent._toolbar.getMenu().Add2((int) (1),(int) (1),BA.ObjectToCharSequence("SMenu"),(android.graphics.drawable.Drawable)(_fim1.getObject()));
 //BA.debugLineNum = 317;BA.debugLine="item2=toolbar.Menu.Add2(2, 2, \"Exit\", eim)";
_item2 = mostCurrent._toolbar.getMenu().Add2((int) (2),(int) (2),BA.ObjectToCharSequence("Exit"),(android.graphics.drawable.Drawable)(_eim.getObject()));
 //BA.debugLineNum = 318;BA.debugLine="item.ShowAsAction = item.SHOW_AS_ACTION_ALWAYS";
_item.setShowAsAction(_item.SHOW_AS_ACTION_ALWAYS);
 //BA.debugLineNum = 319;BA.debugLine="item2.ShowAsAction = item2.SHOW_AS_ACTION_ALWAYS";
_item2.setShowAsAction(_item2.SHOW_AS_ACTION_ALWAYS);
 //BA.debugLineNum = 320;BA.debugLine="item3.ShowAsAction = item3.SHOW_AS_ACTION_ALWAYS";
_item3.setShowAsAction(_item3.SHOW_AS_ACTION_ALWAYS);
 //BA.debugLineNum = 321;BA.debugLine="menu_two";
_menu_two();
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 293;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 295;BA.debugLine="exa.Enabled = False";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 289;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 290;BA.debugLine="file_check";
_file_check();
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 751;BA.debugLine="Sub app_share";
 //BA.debugLineNum = 752;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 753;BA.debugLine="i.Initialize(i.ACTION_SEND, \"\")";
_i.Initialize(_i.ACTION_SEND,"");
 //BA.debugLineNum = 754;BA.debugLine="i.SetType(\"text/plain\")";
_i.SetType("text/plain");
 //BA.debugLineNum = 755;BA.debugLine="i.PutExtra(\"android.intent.extra.TEXT\", \"https://";
_i.PutExtra("android.intent.extra.TEXT",(Object)("https://www.apk-backup-pro.en.uptodown.com/android"));
 //BA.debugLineNum = 756;BA.debugLine="i.PutExtra(\"android.intent.extra.SUBJECT\", \"APK B";
_i.PutExtra("android.intent.extra.SUBJECT",(Object)("APK Backup(Pro) is a free solution for App management on your Android Smartphone. Get it on UpToDown Store"));
 //BA.debugLineNum = 757;BA.debugLine="StartActivity(i)";
...
int _i = 0;
 //BA.debugLineNum = 1334;BA.debugLine="Sub apps_start";
 //BA.debugLineNum = 1335;BA.debugLine="extra.Clear";
mostCurrent._extra.Clear();
 //BA.debugLineNum = 1336;BA.debugLine="applist=pak.GetInstalledPackages";
mostCurrent._applist = _pak.GetInstalledPackages();
 //BA.debugLineNum = 1337;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 1338;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 1339;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 1340;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 1342;BA.debugLine="For i = 0 To size -1";
{
final int step7 = 1;
final int limit7 = (int) (_size-1);
_i = (int) (0) ;
for (;(step7 > 0 && _i <= limit7) || (step7 < 0 && _i >= limit7) ;_i = ((int)(0 + _i + step7))  ) {
 //BA.debugLineNum = 1343;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 1344;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 1345;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 1346;BA.debugLine="idt= Obj3.GetField(\"nativeLibraryDir\")";
mostCurrent._idt = BA.ObjectToString(mostCurrent._obj3.GetField("nativeLibraryDir"));
 //BA.debugLineNum = 1347;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 1348;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 1349;BA.debugLine="sdk= Obj3.GetField(\"targetSdkVersion\")";
_sdk = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("targetSdkVersion")));
 //BA.debugLineNum = 1350;BA.debugLine="apath= Obj3.GetField(\"sourceDir\")";
mostCurrent._apath = BA.ObjectToString(mostCurrent._obj3.GetField("sourceDir"));
 //BA.debugLineNum = 1352;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 1354;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 1355;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 1356;BA.debugLine="name1 = Obj1.RunMethod4(\"getApplicationLabel\",";
mostCurrent._name1 = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 1357;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 1358;BA.debugLine="extra.Add(packName)";
mostCurrent._extra.Add((Object)(mostCurrent._packname));
 };
 }
};
 //BA.debugLineNum = 1361;BA.debugLine="create_lvs";
_create_lvs();
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 803;BA.debugLine="Sub b2dia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 804;BA.debugLine="Select Action";
...
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 808;BA.debugLine="i.Initialize(finish.Get(0),\"\")";
_i.Initialize(BA.ObjectToString(mostCurrent._finish.Get((int) (0))),"");
 //BA.debugLineNum = 809;BA.debugLine="i = pak.GetApplicationIntent(finish.Get(0))";
_i = _pak.GetApplicationIntent(BA.ObjectToString(mostCurrent._finish.Get((int) (0))));
 //BA.debugLineNum = 810;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 //BA.debugLineNum = 811;BA.debugLine="Animator.setanimati(\"slide_from_left\",\"slide_to";
mostCurrent._animator._setanimati(mostCurrent.activityBA,"slide_from_left","slide_to_left");
 break; }
case 1: {
 //BA.debugLineNum = 814;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 817;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
...
public static String  _b3dia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 826;BA.debugLine="Sub b3dia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 827;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 830;BA.debugLine="social_init";
_social_init();
 break; }
case 1: {
 //BA.debugLineNum = 833;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 836;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
public static String  _bckdia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 1087;BA.debugLine="Sub bckdia_ButtonPressed (Dialog As MaterialDialog";
 //BA.debugLineNum = 1088;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 1091;BA.debugLine="svList.SetVisibleAnimated(350,True)";
mostCurrent._svlist.SetVisibleAnimated((int) (350),anywheresoftware.b4a.keywords.Common.True);
 break; }
case 1: {
 //BA.debugLineNum = 1094;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 1097;BA.debugLine="svList.SetVisibleAnimated(350,True)";
mostCurrent._svlist.SetVisibleAnimated((int) (350),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1098;BA.debugLine="ToastMessageShow(Action,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 1070;BA.debugLine="Sub bckdia_ItemLongSelected (Dialog As MaterialDia";
 //BA.debugLineNum = 1071;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1072;BA.debugLine="Log(\"2_EXPAN: \"&s)";
anywheresoftware.b4a.keywords.Common.Log("2_EXPAN: "+_s);
 //BA.debugLineNum = 1073;BA.debugLine="name1=s&\".apk\"";
mostCurrent._name1 = _s+".apk";
 //BA.debugLineNum = 1074;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 1075;BA.debugLine="Dim dlab,dcont As Label";
_dlab = new anywheresoftware.b4a.objects.LabelWrapper();
_dcont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1076;BA.debugLine="dlab.Initialize(\"\")";
_dlab.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1077;BA.debugLine="dcont.Initialize(\"\")";
_dcont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1078;BA.debugLine="dlab.TextSize=15";
_dlab.setTextSize((float) (15));
 //BA.debugLineNum = 1079;BA.debugLine="dcont.TextSize=14";
_dcont.setTextSize((float) (14));
 //BA.debugLineNum = 1080;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 1081;BA.debugLine="Builder.Initialize(\"cidia\")";
_builder.Initialize(mostCurrent.activityBA,"cidia");
 //BA.debugLineNum = 1082;BA.debugLine="Builder.Title(dlab.text).TitleColor(mcl.md_black";
_builder.Title(BA.ObjectToCharSequence(_dlab.getText())).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_dcont.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.True).AutoDismiss(anywheresoftware.b4a.keywords.Common.False).NeutralText(BA.ObjectToCharSequence("Ok")).NeutralColor(mostCurrent._mcl.getmd_black_1000()).ItemsCallback().Build();
 //BA.debugLineNum = 1083;BA.debugLine="Builder.ForceStacking(True)";
_builder.ForceStacking(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1084;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 1085;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
 //BA.debugLineNum = 1086;BA.debugLine="End Sub";
return "";
}
public static String  _btb_navigationitemclick() throws Exception{
 //BA.debugLineNum = 422;BA.debugLine="Sub btb_NavigationItemClick";
 //BA.debugLineNum = 423;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 424;BA.debugLine="End Sub";
return "";
}
public static String  _butt_click() throws Exception{
 //BA.debugLineNum = 1546;BA.debugLine="Sub butt_Click";
 //BA.debugLineNum = 1547;BA.debugLine="ab1_Click";
_ab1_click();
...
String _text = "";
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 788;BA.debugLine="Sub butt2_click";
 //BA.debugLineNum = 789;BA.debugLine="Dim lab As Label";
_lab = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 790;BA.debugLine="lab.Initialize(\"lab\")";
_lab.Initialize(mostCurrent.activityBA,"lab");
 //BA.debugLineNum = 791;BA.debugLine="Dim text As String = \"Start \"&pak.GetApplicationL";
_text = "Start "+_pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))+"?";
 //BA.debugLineNum = 792;BA.debugLine="lab.TextSize=18";
_lab.setTextSize((float) (18));
 //BA.debugLineNum = 793;BA.debugLine="lab.Gravity=Gravity.CENTER_HORIZONTAL";
_lab.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 794;BA.debugLine="lab.TextColor=mcl.md_black_1000";
_lab.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 795;BA.debugLine="lab.Text=text";
_lab.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 796;BA.debugLine="icon=pak.GetApplicationIcon(finish.Get(0))";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))));
 //BA.debugLineNum = 797;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 798;BA.debugLine="Builder.Initialize(\"b2dia\")";
_builder.Initialize(mostCurrent.activityBA,"b2dia");
 //BA.debugLineNum = 799;BA.debugLine="Builder.Title(pak.GetApplicationLabel(finish.Get(";
_builder.Title(BA.ObjectToCharSequence(_pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._finish.Get((int) (0)))))).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_lab.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Ok")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("Cancel")).NeutralColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 800;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 801;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
 //BA.debugLineNum = 802;BA.debugLine="End Sub";
return "";
}
public static String  _butt3_click() throws Exception{
 //BA.debugLineNum = 822;BA.debugLine="Sub butt3_click";
 //BA.debugLineNum = 823;BA.debugLine="social_init";
_social_init();
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bg1 = null;
 //BA.debugLineNum = 1427;BA.debugLine="Sub cbut_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 1428;BA.debugLine="Dim bg As BitmapDrawable";
_bg = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 1429;BA.debugLine="bg.Initialize(LoadBitmap(File.DirAssets,\"ic_check";
_bg.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_check_box_outline_blank_black_36dp.png").getObject()));
 //BA.debugLineNum = 1430;BA.debugLine="Dim bg1 As BitmapDrawable";
_bg1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 1431;BA.debugLine="bg1.Initialize(LoadBitmap(File.DirAssets,\"ic_chec";
_bg1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_check_box_black_36dp.png").getObject()));
 //BA.debugLineNum = 1432;BA.debugLine="Select Checked";
switch (BA.switchObjectToInt(_checked,_checked==anywheresoftware.b4a.keywords.Common.True,_checked==anywheresoftware.b4a.keywords.Common.False)) {
case 0: {
 //BA.debugLineNum = 1434;BA.debugLine="cbut.Enabled=False";
mostCurrent._cbut.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 break; }
case 1: {
 //BA.debugLineNum = 1436;BA.debugLine="cbut.Enabled=True";
...
public static String  _chk_dtas() throws Exception{
 //BA.debugLineNum = 840;BA.debugLine="Sub chk_dtas";
 //BA.debugLineNum = 841;BA.debugLine="packName=finish.Get(0)";
mostCurrent._packname = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 842;BA.debugLine="If dtime.ContainsKey(packName) Then";
if (mostCurrent._dtime._containskey(mostCurrent._packname)) { 
 //BA.debugLineNum = 843;BA.debugLine="int_folder";
_int_folder();
 //BA.debugLineNum = 845;BA.debugLine="lst.CheckedColor=mcl.md_green_400";
mostCurrent._lst._checkedcolor = mostCurrent._mcl.getmd_green_400();
 }else {
 //BA.debugLineNum = 848;BA.debugLine="ab1_Click";
_ab1_click();
 };
...
String _s = "";
 //BA.debugLineNum = 944;BA.debugLine="Sub cidia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 945;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 947;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 948;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 949;BA.debugLine="name1=s&\".apk\"";
mostCurrent._name1 = _s+".apk";
 //BA.debugLineNum = 950;BA.debugLine="Log(\"cidia: \"&name1)";
anywheresoftware.b4a.keywords.Common.Log("cidia: "+mostCurrent._name1);
 //BA.debugLineNum = 951;BA.debugLine="File.Delete(dir,name1)";
anywheresoftware.b4a.keywords.Common.File.Delete(mostCurrent._dir,mostCurrent._name1);
 //BA.debugLineNum = 952;BA.debugLine="If Not(File.Exists(dir,name1)) Then";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._dir,mostCurrent._name1))) { 
 //BA.debugLineNum = 953;BA.debugLine="Dialog.Dismiss";
_dialog.Dismiss();
 };
 break; }
case 1: {
 //BA.debugLineNum = 956;BA.debugLine="ToastMessageShow(\"canceled\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled"),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 958;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
public static String  _cldia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 593;BA.debugLine="Sub cldia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 594;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 596;BA.debugLine="ExitApplication";
anywheresoftware.b4a.keywords.Common.ExitApplication();
 break; }
case 1: {
 //BA.debugLineNum = 598;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 600;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 585;BA.debugLine="Sub close_click";
 //BA.debugLineNum = 586;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_inf";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_info_black_36dp.png").getObject()));
 //BA.debugLineNum = 587;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 588;BA.debugLine="Builder.Initialize(\"cldia\")";
_builder.Initialize(mostCurrent.activityBA,"cldia");
 //BA.debugLineNum = 589;BA.debugLine="Builder.Title(\"Exit\").TitleColor(mcl.md_black_100";
_builder.Title(BA.ObjectToCharSequence("Exit")).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence("Close Apk Backup(Pro) now?")).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Yes")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("No")).NeutralColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 590;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 591;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
Object _id = null;
int _i = 0;
 //BA.debugLineNum = 1364;BA.debugLine="Sub create_lvs";
 //BA.debugLineNum = 1365;BA.debugLine="Dim total,bcksizie As String, ID As Object";
_total = "";
_bcksizie = "";
_id = new Object();
 //BA.debugLineNum = 1366;BA.debugLine="pn.Clear";
mostCurrent._pn.Clear();
 //BA.debugLineNum = 1367;BA.debugLine="bcksizie=dtime.ListKeys.Size";
_bcksizie = BA.NumberToString(mostCurrent._dtime._listkeys().getSize());
 //BA.debugLineNum = 1369;BA.debugLine="lst.AddHeader(\"App(s): \"&extra.size&\", Backup(s):";
mostCurrent._lst._addheader("App(s): "+BA.NumberToString(mostCurrent._extra.getSize())+", Backup(s): "+_bcksizie);
 //BA.debugLineNum = 1371;BA.debugLine="For i=0 To   extra.Size-1";
{
final int step5 = 1;
final int limit5 = (int) (mostCurrent._extra.getSize()-1);
_i = (int) (0) ;
for (;(step5 > 0 && _i <= limit5) || (step5 < 0 && _i >= limit5) ;_i = ((int)(0 + _i + step5))  ) {
 //BA.debugLineNum = 1372;BA.debugLine="ID=extra.Get(i)";
_id = mostCurrent._extra.Get(_i);
 //BA.debugLineNum = 1373;BA.debugLine="name1=pak.GetApplicationLabel(extra.Get(i))";
mostCurrent._name1 = _pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._extra.Get(_i)));
 //BA.debugLineNum = 1374;BA.debugLine="total =pak.GetVersionName(extra.Get(i))";
_total = _pak.GetVersionName(BA.ObjectToString(mostCurrent._extra.Get(_i)));
 //BA.debugLineNum = 1376;BA.debugLine="lst.AddCustomItem(ID,CreateItem(name1&\" \"&total,";
mostCurrent._lst._addcustomitem(_id,_createitem(mostCurrent._name1+" "+_total,_i),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 ...
 //BA.debugLineNum = 1378;BA.debugLine="lst.ResizePanel";
...
anywheresoftware.b4a.keywords.constants.TypefaceWrapper _font = null;
 //BA.debugLineNum = 1380;BA.debugLine="Sub CreateItem(h As String  , i As Int) As Panel";
 //BA.debugLineNum = 1381;BA.debugLine="Dim lbl,ver As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_ver = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1382;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1383;BA.debugLine="pnl.Initialize(\"\")";
_pnl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1384;BA.debugLine="Dim bg As BitmapDrawable";
_bg = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 1385;BA.debugLine="bg.Initialize(LoadBitmap(File.DirAssets,\"ic_check";
_bg.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_check_box_outline_blank_black_36dp.png").getObject()));
 //BA.debugLineNum = 1386;BA.debugLine="Dim bg1 As BitmapDrawable";
_bg1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 1387;BA.debugLine="bg1.Initialize(LoadBitmap(File.DirAssets,\"ic_chec";
_bg1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_check_box_black_36dp.png").getObject()));
 //BA.debugLineNum = 1388;BA.debugLine="Dim iiv As ImageView";
_iiv = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 1389;BA.debugLine="iiv.Initialize(\"\")";
_iiv.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1390;BA.debugLine="Dim cfont As Typeface=Typeface.LoadFromAssets(\"Op";
...
_cfont.setObject((android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf")));
 //BA.debugLineNum = 1392;BA.debugLine="cbut.Initialize(\"cbut\")";
mostCurrent._cbut.Initialize(mostCurrent.activityBA,"cbut");
 //BA.debugLineNum = 1393;BA.debugLine="cbut.Gravity=Gravity.FILL";
mostCurrent._cbut.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 1394;BA.debugLine="cbut.Enabled=False";
mostCurrent._cbut.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1395;BA.debugLine="icon=pak.GetApplicationIcon(extra.Get(i))";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(BA.ObjectToString(mostCurrent._extra.Get(_i)))));
 //BA.debugLineNum = 1396;BA.debugLine="icon.Gravity=Gravity.FILL";
mostCurrent._icon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 1397;BA.debugLine="iiv.Bitmap=icon.Bitmap";
_iiv.setBitmap(mostCurrent._icon.getBitmap());
 //BA.debugLineNum = 1398;BA.debugLine="Dim font As Typeface";
_font = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
 //BA.debugLineNum = 1399;BA.debugLine="font=Typeface.CreateNew(Typeface.LoadFromAssets(\"";
_font.setObject((android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.CreateNew(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf"),anywheresoftware.b4a.keywords.Common.Typeface.STYLE_ITALIC)));
 //BA.debugLineNum = 1400;BA.debugLine="If dtime.ContainsKey(extra.Get(i)) Then";
if (mostCurrent._dtime._containskey(BA.ObjectToString(mostCurrent._extra.Get(_i)))) { 
 //BA.debugLineNum = 1401;BA.debugLine="cbut.Checked=True";
mostCurrent._cbut.setChecked(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1402;BA.debugLine="paint_pan(pnl,2)";
_paint_pan(_pnl,(int) (2));
 }else {
 //BA.debugLineNum = 1404;BA.debugLine="cbut.Checked=False";
mostCurrent._cbut.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1405;BA.debugLine="paint_pan(pnl,0)";
_paint_pan(_pnl,(int) (0));
 };
 //BA.debugLineNum = 1407;BA.debugLine="pnl.AddView(cbut, 0dip, 8dip, 42dip, 42dip)";
_pnl.AddView((android.view.View)(mostCurrent._cbut.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (42)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (42)));
 //BA.debugLineNum = 1408;BA.debugLine="lbl.Initialize(\"\") 'View #1";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1409;BA.debugLine="lbl.Typeface=cfont";
_lbl.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1410;BA.debugLine="lbl.Text= h";
_lbl.setText(BA.ObjectToCharSequence(_h));
 //BA.debugLineNum = 1411;BA.debugLine="lbl.TextColor = mcl.md_blue_700";
_lbl.setTextColor(mostCurrent._mcl.getmd_blue_700());
 //BA.debugLineNum = 1412;BA.debugLine="lbl.TextSize = 18";
_lbl.setTextSize((float) (18));
 //BA.debugLineNum = 1413;BA.debugLine="lbl.Gravity = Gravity.CENTER_VERTICAL";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 1414;BA.debugLine="ver.Initialize(\"\")";
_ver.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1415;BA.debugLine="ver.TextColor=Colors.DarkGray";
_ver.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.DarkGray);
 //BA.debugLineNum = 1416;BA.debugLine="ver.Typeface=font";
_ver.setTypeface((android.graphics.Typeface)(_font.getObject()));
 //BA.debugLineNum = 1417;BA.debugLine="ver.TextSize=13";
_ver.setTextSize((float) (13));
 //BA.debugLineNum = 1418;BA.debugLine="ver.Gravity = Gravity.LEFT";
_ver.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.LEFT);
 //BA.debugLineNum = 1419;BA.debugLine="ver.Text=extra.Get(i)";
_ver.setText(BA.ObjectToCharSequence(mostCurrent._extra.Get(_i)));
 //BA.debugLineNum = 1420;BA.debugLine="iiv.Gravity=Gravity.FILL";
_iiv.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 1421;BA.debugLine="pnl.AddView(lbl, 43dip, 0, lst.getWidth - 130dip,";
_pnl.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (43)),(int) (0),(int) ((double)(Double.parseDouble(mostCurrent._lst._getwidth()))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (130))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1422;BA.debugLine="pnl.AddView(ver, 43dip, lbl.Height, lst.getWidth";
_pnl.AddView((android.view.View)(_ver.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (43)),_lbl.getHeight(),(int) ((double)(Double.parseDouble(mostCurrent._lst._getwidth()))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1423;BA.debugLine="pnl.AddView(iiv,82%x,3dip,52dip,52dip)";
_pnl.AddView((android.view.View)(_iiv.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (82),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (3)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52)));
 //BA.debugLineNum = 1425;BA.debugLine="Return pnl";
if (true) return _pnl;
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
String _i = "";
 //BA.debugLineNum = 626;BA.debugLine="Sub del_dia";
 //BA.debugLineNum = 627;BA.debugLine="Dim imi As MaterialSimpleListItem";
_imi = new de.amberhome.materialdialogs.MaterialSimpleListItemWrapper();
 //BA.debugLineNum = 628;BA.debugLine="Dim dlab,dcont As Label";
_dlab = new anywheresoftware.b4a.objects.LabelWrapper();
_dcont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 629;BA.debugLine="dlab.Initialize(\"\")";
_dlab.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 630;BA.debugLine="dcont.Initialize(\"\")";
_dcont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 631;BA.debugLine="dlab.TextSize=15";
_dlab.setTextSize((float) (15));
 //BA.debugLineNum = 632;BA.debugLine="dcont.TextSize=14";
_dcont.setTextSize((float) (14));
 //BA.debugLineNum = 633;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 634;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 635;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 637;BA.debugLine="dlist=File.ListFiles(dir)";
_dlist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._dir);
 //BA.debugLineNum = 638;BA.debugLine="dlab.Text=\"Delete Backup Archive ?\"";
_dlab.setText(BA.ObjectToCharSequence("Delete Backup Archive ?"));
 //BA.debugLineNum = 639;BA.debugLine="dcont.Text=\"Files to clear: \"&dlist.size&\" apk´s";
_dcont.setText(BA.ObjectToCharSequence("Files to clear: "+BA.NumberToString(_dlist.getSize())+" apk´s found"));
 //BA.debugLineNum = 640;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_sd_";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sd_storage_black_36dp.png").getObject()));
 //BA.debugLineNum = 641;BA.debugLine="icon.Gravity=Gravity.FILL";
mostCurrent._icon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 642;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 643;BA.debugLine="Builder.Initialize(\"Dialog2\")";
_builder.Initialize(mostCurrent.activityBA,"Dialog2");
 //BA.debugLineNum = 644;BA.debugLine="Builder.Title(dlab.text).TitleColor(mcl.md_black_";
_builder.Title(BA.ObjectToCharSequence(_dlab.getText())).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_dcont.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Yes delete")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("Cancel")).NeutralColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 645;BA.debugLine="For Each i As String In dlist";
{
...
_i = BA.ObjectToString(group18.Get(index18));
 //BA.debugLineNum = 646;BA.debugLine="imi.Initialize2(\"ili\",i)";
_imi.Initialize2(processBA,"ili",BA.ObjectToCharSequence(_i));
 //BA.debugLineNum = 647;BA.debugLine="Builder.AddSimpleItem(imi)";
_builder.AddSimpleItem(_imi);
 }
};
 //BA.debugLineNum = 649;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 650;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
anywheresoftware.b4a.objects.collections.List _dlist = null;
int _maxs = 0;
 //BA.debugLineNum = 653;BA.debugLine="Sub delete_files";
 //BA.debugLineNum = 654;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 655;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 656;BA.debugLine="Dim maxs As Int";
_maxs = 0;
 //BA.debugLineNum = 657;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 658;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 660;BA.debugLine="dlist=File.ListFiles(dir)";
_dlist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._dir);
 //BA.debugLineNum = 661;BA.debugLine="maxs=dlist.Size";
_maxs = _dlist.getSize();
 //BA.debugLineNum = 663;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_ass";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_black_36dp.png").getObject()));
 //BA.debugLineNum = 664;BA.debugLine="Builder.Initialize(\"Dialog4\")";
_builder.Initialize(mostCurrent.activityBA,"Dialog4");
 //BA.debugLineNum = 665;BA.debugLine="Builder.Title(\"cleaning..\").TitleColor(mcl.md_bla";
_builder.Title(BA.ObjectToCharSequence("cleaning..")).TitleColor(mostCurrent._mcl.getmd_black_1000()).TitleGravity(_builder.GRAVITY_START).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence("Delete Apk´s from: "+mostCurrent._datas._getsimple("0"))).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).Build();
 //BA.debugLineNum = 666;BA.debugLine="Builder.progress2(False,maxs,True)";
_builder.Progress2(anywheresoftware.b4a.keywords.Common.False,_maxs,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 667;BA.debugLine="df=Builder.Show";
mostCurrent._df = _builder.Show();
 //BA.debugLineNum = 668;BA.debugLine="df.Show";
mostCurrent._df.Show();
 //BA.debugLineNum = 669;BA.debugLine="dex.Enabled=True";
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 720;BA.debugLine="Sub dev_info";
 //BA.debugLineNum = 721;BA.debugLine="Dim l1,l2 As Label";
_l1 = new anywheresoftware.b4a.objects.LabelWrapper();
_l2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 722;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 723;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 724;BA.debugLine="l1.Initialize(\"\")";
_l1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 725;BA.debugLine="l2.Initialize(\"\")";
_l2.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 726;BA.debugLine="l2.TextSize=16";
_l2.setTextSize((float) (16));
 //BA.debugLineNum = 727;BA.debugLine="l1.TextSize=15";
_l1.setTextSize((float) (15));
 //BA.debugLineNum = 728;BA.debugLine="l1.textcolor=Colors.ARGB(200,255,255,255)";
_l1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 729;BA.debugLine="l2.textcolor=mcl.md_black_1000";
_l2.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 730;BA.debugLine="l1.Gravity=Gravity.TOP";
_l1.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.TOP);
 //BA.debugLineNum = 731;BA.debugLine="l1.Typeface=Typeface.LoadFromAssets(\"OpenSans.ttf";
_l1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf"));
 //BA.debugLineNum = 732;BA.debugLine="l2.Typeface=Typeface.LoadFromAssets(\"OpenSans.ttf";
_l2.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf"));
 //BA.debugLineNum = 733;BA.debugLine="l2.Text=\"About \"&pak.GetApplicationLabel(\"com.apk";
_l2.setText(BA.ObjectToCharSequence("About "+_pak.GetApplicationLabel("com.apkbackup.de")));
 //BA.debugLineNum = 734;BA.debugLine="l1.Text=pak.GetApplicationLabel(\"com.apkbackup.de";
_l1.setText(BA.ObjectToCharSequence(_pak.GetApplicationLabel("com.apkbackup.de")+", Version: "+_pak.GetVersionName("com.apkbackup.de")+" | Build: "+BA.NumberToString(_pak.GetVersionCode("com.apkbackup.de"))+". Code/Design by D. Trojan, www.sulomedia.de for Support/Infos. APK Backup(Pro) by SuloMedia ©2017"));
 //BA.debugLineNum = 735;BA.debugLine="pnl.AddView(l1,25dip,1dip,88%x,98%y)";
_pnl.AddView((android.view.View)(_l1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (88),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (98),mostCurrent.activityBA));
 //BA.debugLineNum = 736;BA.debugLine="Dim infodia As MaterialDialog";
_infodia = new de.amberhome.materialdialogs.MaterialDialogWrapper();
 //BA.debugLineNum = 737;BA.debugLine="Dim info As BitmapDrawable";
_info = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 738;BA.debugLine="info.Initialize(LoadBitmap(File.DirAssets,\"ic_inf";
_info.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_info_outline_black_36dp.png").getObject()));
 //BA.debugLineNum = 739;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 740;BA.debugLine="Builder.Initialize(\"Dialog3\")";
_builder.Initialize(mostCurrent.activityBA,"Dialog3");
 //BA.debugLineNum = 741;BA.debugLine="Builder.Title(l2.Text).TitleColor(mcl.md_black_10";
_builder.Title(BA.ObjectToCharSequence(_l2.getText())).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(_info.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_l1.getText())).ContentLineSpacing((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)))).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.True).NeutralText(BA.ObjectToCharSequence("close")).NeutralColor(mostCurrent._mcl.getmd_blue_600()).Theme(_builder.THEME_LIGHT).ContentGravity(_builder.GRAVITY_START);
 //BA.debugLineNum = 742;BA.debugLine="infodia=Builder.Show";
_infodia = _builder.Show();
 //BA.debugLineNum = 743;BA.debugLine="infodia.Show";
_infodia.Show();
 //BA.debugLineNum = 745;BA.debugLine="End Sub";
return "";
}
public static String  _dex_tick() throws Exception{
 //BA.debugLineNum = 672;BA.debugLine="Sub dex_Tick";
 //BA.debugLineNum = 673;BA.debugLine="If Not(df.IsShowing) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._df.IsShowing())) { 
 //BA.debugLineNum = 674;BA.debugLine="dex.Enabled = False";
_dex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 675;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 677;BA.debugLine="If df.CurrentProgress = df.MaxProgress Then";
if (mostCurrent._df.getCurrentProgress()==mostCurrent._df.getMaxProgress()) { 
 //BA.debugLineNum = 678;BA.debugLine="dex.Enabled = False";
_dex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 679;BA.debugLine="df.Content = \"Done! Please wait..\"";
mostCurrent._df.setContent(BA.ObjectToCharSequence("Done! Please wait.."));
 //BA.debugLineNum = 680;BA.debugLine="StartActivity(swit)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._swit.getObject()));
 //BA.debugLineNum = 681;BA.debugLine="df.Dismiss";
mostCurrent._df.Dismiss();
 //BA.debugLineNum = 682;BA.debugLine="file_check";
_file_check();
 //BA.debugLineNum = 683;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 684;BA.debugLine="Animator.setanimati(\"slide_from_left\",\"slide_to_";
mostCurrent._animator._setanimati(mostCurrent.activityBA,"slide_from_left","slide_to_left");
 }else {
 //BA.debugLineNum = 686;BA.debugLine="df.IncrementProgress(1)";
mostCurrent._df.IncrementProgress((int) (1));
 //BA.debugLineNum = 687;BA.debugLine="file_clear";
_file_clear();
 };
...
public static String  _dialog2_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 706;BA.debugLine="Sub Dialog2_ButtonPressed (Dialog As MaterialDialo";
 //BA.debugLineNum = 707;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 710;BA.debugLine="delete_files";
_delete_files();
 break; }
case 1: {
 //BA.debugLineNum = 713;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 716;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
String _total = "";
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 1134;BA.debugLine="Sub end_msg";
 //BA.debugLineNum = 1135;BA.debugLine="Dim dirs As String";
_dirs = "";
 //BA.debugLineNum = 1136;BA.debugLine="If datas.ContainsKey(\"0\") Then";
if (mostCurrent._datas._containskey("0")) { 
 //BA.debugLineNum = 1137;BA.debugLine="dirs=datas.GetSimple(\"0\")";
_dirs = mostCurrent._datas._getsimple("0");
 };
 //BA.debugLineNum = 1139;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1140;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 1141;BA.debugLine="Dim e As String=finish.get(0)";
_e = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1142;BA.debugLine="name1=pak.GetApplicationLabel(e)";
...
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(_s)));
 //BA.debugLineNum = 1144;BA.debugLine="Label4.Text=name1";
mostCurrent._label4.setText(BA.ObjectToCharSequence(mostCurrent._name1));
 //BA.debugLineNum = 1145;BA.debugLine="Dim total As String";
_total = "";
 //BA.debugLineNum = 1146;BA.debugLine="total = FormatFileSize(File.Size(GetParentPath(Ge";
_total = _formatfilesize((float) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(mostCurrent._packname))),_getfilename(_getsourcedir(_getactivitiesinfo(mostCurrent._packname))))));
 //BA.debugLineNum = 1147;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 1148;BA.debugLine="Builder.Initialize(\"endia\")";
_builder.Initialize(mostCurrent.activityBA,"endia");
 //BA.debugLineNum = 1149;BA.debugLine="Builder.Title(\"Complete..\").TitleColor(mcl.md_bla";
_builder.Title(BA.ObjectToCharSequence("Complete..")).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence("Backup Info:")).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.False).PositiveText(BA.ObjectToCharSequence("Next..")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("")).NeutralColor(mostCurrent._mcl.getmd_black_1000()).ForceStacking(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1150;BA.debugLine="Builder.Items(Array As String (packName&\".apk\",to";
_builder.Items((java.lang.CharSequence[])(new String[]{mostCurrent._packname+".apk",_total,"SD:",_dirs}));
 //BA.debugLineNum = 1151;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 1152;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
public static String  _endia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 1155;BA.debugLine="Sub endia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 1156;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 1162;BA.debugLine="file_check";
_file_check();
 //BA.debugLineNum = 1163;BA.debugLine="lst.ResizePanel";
mostCurrent._lst._resizepanel();
 //BA.debugLineNum = 1164;BA.debugLine="pdia.Dismiss";
mostCurrent._pdia.Dismiss();
 //BA.debugLineNum = 1165;BA.debugLine="deldia.Dismiss";
mostCurrent._deldia.Dismiss();
 //BA.debugLineNum = 1166;BA.debugLine="CallSubDelayed(swit,\"rebound\")";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._swit.getObject()),"rebound");
 //BA.debugLineNum = 1167;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 break; }
case 1: {
 //BA.debugLineNum = 1169;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 1171;BA.debugLine="ToastMessageShow(Action,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
String _total = "";
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 1032;BA.debugLine="Sub ex_pan";
 //BA.debugLineNum = 1033;BA.debugLine="Dim fname,version As String";
_fname = "";
_version = "";
 //BA.debugLineNum = 1034;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1035;BA.debugLine="fname=pak.GetApplicationLabel(s)";
_fname = _pak.GetApplicationLabel(_s);
 //BA.debugLineNum = 1036;BA.debugLine="version=pak.GetVersionName(s)";
_version = _pak.GetVersionName(_s);
 //BA.debugLineNum = 1037;BA.debugLine="Log(\"EXPAN: \"&s)";
anywheresoftware.b4a.keywords.Common.Log("EXPAN: "+_s);
 //BA.debugLineNum = 1038;BA.debugLine="name1=fname&\"_\"&version&\".apk\"";
mostCurrent._name1 = _fname+"_"+_version+".apk";
 //BA.debugLineNum = 1039;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 1040;BA.debugLine="Bpath.Text=datas.GetSimple(\"0\")";
mostCurrent._bpath.setText(BA.ObjectToCharSequence(mostCurrent._datas._getsimple("0")));
 //BA.debugLineNum = 1041;BA.debugLine="For Each h As String In extra";
{
...
_h = BA.ObjectToString(group9.Get(index9));
 //BA.debugLineNum = 1042;BA.debugLine="If s=h Then";
if ((_s).equals(_h)) { 
 //BA.debugLineNum = 1043;BA.debugLine="Bname.Text=pak.GetApplicationLabel(h)";
mostCurrent._bname.setText(BA.ObjectToCharSequence(_pak.GetApplicationLabel(_h)));
 //BA.debugLineNum = 1044;BA.debugLine="icon=pak.GetApplicationIcon(h)";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(_h)));
 }else {
 //BA.debugLineNum = 1046;BA.debugLine="Bname.Text=name1";
mostCurrent._bname.setText(BA.ObjectToCharSequence(mostCurrent._name1));
 //BA.debugLineNum = 1047;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_black_36dp.png").getObject()));
 };
 }
};
 //BA.debugLineNum = 1050;BA.debugLine="Dim l1,l2,l3 As Label";
_l1 = new anywheresoftware.b4a.objects.LabelWrapper();
_l2 = new anywheresoftware.b4a.objects.LabelWrapper();
_l3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1051;BA.debugLine="l1.Initialize(\"\")";
_l1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1052;BA.debugLine="l2.Initialize(\"\")";
_l2.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1053;BA.debugLine="l3.Initialize(\"\")";
_l3.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1054;BA.debugLine="l3.Text=Bpath.Text";
_l3.setText(BA.ObjectToCharSequence(mostCurrent._bpath.getText()));
 //BA.debugLineNum = 1055;BA.debugLine="l2.Text=dtime.GetSimple(s)";
_l2.setText(BA.ObjectToCharSequence(mostCurrent._dtime._getsimple(_s)));
 //BA.debugLineNum = 1056;BA.debugLine="Dim total As String";
_total = "";
 //BA.debugLineNum = 1057;BA.debugLine="total = \"size: \"&FormatFileSize(File.Size(Bpath.t";
_total = "size: "+_formatfilesize((float) (anywheresoftware.b4a.keywords.Common.File.Size(mostCurrent._bpath.getText(),mostCurrent._name1)));
 //BA.debugLineNum = 1058;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 1059;BA.debugLine="Builder.Initialize(\"bckdia\")";
_builder.Initialize(mostCurrent.activityBA,"bckdia");
 //BA.debugLineNum = 1060;BA.debugLine="Builder.Title(\"Backup Info:\").TitleColor(mcl.md_b";
_builder.Title(BA.ObjectToCharSequence("Backup Info:")).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(mostCurrent._bname.getText())).ContentLineSpacing((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)))).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Ok")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("")).NeutralColor(mostCurrent._mcl.getmd_black_1000()).ItemsColor(mostCurrent._mcl.getmd_blue_600()).ItemsGravity(_builder.GRAVITY_START).MaxIconSize((int) (64)).AlwaysCallSingleChoiceCallback().ForceStacking(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1063;BA.debugLine="Builder.Items(Array As String (packName,total,l2";
_builder.Items((java.lang.CharSequence[])(new String[]{mostCurrent._packname,_total,_l2.getText()}));
 //BA.debugLineNum = 1066;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 1067;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
String _p = "";
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 1269;BA.debugLine="Sub ex_pan2";
 //BA.debugLineNum = 1270;BA.debugLine="Dim a1,version As String";
_a1 = "";
_version = "";
 //BA.debugLineNum = 1271;BA.debugLine="Dim sum As Int";
_sum = 0;
 //BA.debugLineNum = 1272;BA.debugLine="Dim extitel As Label";
_extitel = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1273;BA.debugLine="extitel.Initialize(\"\")";
_extitel.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1274;BA.debugLine="Dim s,p As String";
_s = "";
_p = "";
 //BA.debugLineNum = 1275;BA.debugLine="s=finish.Get(\"0\")";
_s = BA.ObjectToString(mostCurrent._finish.Get((int)(Double.parseDouble("0"))));
 //BA.debugLineNum = 1276;BA.debugLine="p=GetParentPath(GetSourceDir(GetActivitiesInfo(s)";
_p = _getparentpath(_getsourcedir(_getactivitiesinfo(_s)));
 //BA.debugLineNum = 1277;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 1278;BA.debugLine="name1=pak.GetApplicationLabel(s)";
mostCurrent._name1 = _pak.GetApplicationLabel(_s);
 //BA.debugLineNum = 1279;BA.debugLine="version=pak.GetVersionName(s)";
_version = _pak.GetVersionName(_s);
 //BA.debugLineNum = 1280;BA.debugLine="extitel.Text=name1";
_extitel.setText(BA.ObjectToCharSequence(mostCurrent._name1));
 //BA.debugLineNum = 1281;BA.debugLine="extitel.TextSize=11";
_extitel.setTextSize((float) (11));
 //BA.debugLineNum = 1282;BA.debugLine="icon=pak.GetApplicationIcon(s)";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(_s)));
 //BA.debugLineNum = 1283;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1284;BA.debugLine="size=File.Size(GetParentPath(GetSourceDir(GetActi";
_size = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._finish.Get((int)(Double.parseDouble("0"))))))),_getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._finish.Get((int)(Double.parseDouble("0")))))))));
 //BA.debugLineNum = 1285;BA.debugLine="Label4.Text=packName&\"->-> \"&name1&\"_\"&version&\".";
mostCurrent._label4.setText(BA.ObjectToCharSequence(mostCurrent._packname+"->-> "+mostCurrent._name1+"_"+_version+".apk ("+_formatfilesize((float) (_size))+") to: "+mostCurrent._dir));
 //BA.debugLineNum = 1286;BA.debugLine="Label4.TextColor=mcl.md_black_1000";
mostCurrent._label4.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 1287;BA.debugLine="Label4.TextSize=12";
mostCurrent._label4.setTextSize((float) (12));
 //BA.debugLineNum = 1288;BA.debugLine="Label4.Gravity=Gravity.FILL";
mostCurrent._label4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 1289;BA.debugLine="Label4.Typeface=superfont";
mostCurrent._label4.setTypeface((android.graphics.Typeface)(mostCurrent._superfont.getObject()));
 //BA.debugLineNum = 1290;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 1291;BA.debugLine="Builder.Initialize(\"Dialog\")";
_builder.Initialize(mostCurrent.activityBA,"Dialog");
 //BA.debugLineNum = 1292;BA.debugLine="Builder.Title(extitel.Text).TitleColor(mcl.md_blu";
_builder.Title(BA.ObjectToCharSequence(_extitel.getText())).TitleColor(mostCurrent._mcl.getmd_blue_A400()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(mostCurrent._label4.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).Build();
 //BA.debugLineNum = 1293;BA.debugLine="a1=File.Size(p,GetFileName(GetSourceDir(GetActivi";
_a1 = BA.NumberToString(anywheresoftware.b4a.keywords.Common.File.Size(_p,_getfilename(_getsourcedir(_getactivitiesinfo(_s)))));
 //BA.debugLineNum = 1294;BA.debugLine="sum=a1/1024/1024";
_sum = (int) ((double)(Double.parseDouble(_a1))/(double)1024/(double)1024);
 //BA.debugLineNum = 1295;BA.debugLine="Builder.progress2(False,sum,True)";
_builder.Progress2(anywheresoftware.b4a.keywords.Common.False,_sum,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1296;BA.debugLine="pdia=Builder.Show";
mostCurrent._pdia = _builder.Show();
 //BA.debugLineNum = 1297;BA.debugLine="pdia.CurrentProgress=0";
mostCurrent._pdia.setCurrentProgress((int) (0));
 //BA.debugLineNum = 1298;BA.debugLine="tcount=0";
_tcount = (int) (0);
 //BA.debugLineNum = 1299;BA.debugLine="ex.Enabled=True";
...
int _maxs = 0;
int _i = 0;
 //BA.debugLineNum = 502;BA.debugLine="Sub ex_start";
 //BA.debugLineNum = 503;BA.debugLine="ProgressDialogShow(\"please wait...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("please wait..."));
 //BA.debugLineNum = 504;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 505;BA.debugLine="Dim maxs As Int";
_maxs = 0;
 //BA.debugLineNum = 506;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 507;BA.debugLine="maxs=exalist.Size";
_maxs = mostCurrent._exalist.getSize();
 //BA.debugLineNum = 508;BA.debugLine="For i =0 To exalist.Size-1";
{
final int step6 = 1;
final int limit6 = (int) (mostCurrent._exalist.getSize()-1);
_i = (int) (0) ;
for (;(step6 > 0 && _i <= limit6) || (step6 < 0 && _i >= limit6) ;_i = ((int)(0 + _i + step6))  ) {
 //BA.debugLineNum = 509;BA.debugLine="size=File.Size(GetParentPath(GetSourceDir(GetAct";
_size = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._exalist.Get(_i))))),_getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._exalist.Get(_i))))))*1024*10);
 ...
 //BA.debugLineNum = 511;BA.debugLine="Label4.Text=\"copying to\"&dir&\"(\"&FormatFileSize(s";
mostCurrent._label4.setText(BA.ObjectToCharSequence("copying to"+mostCurrent._dir+"("+_formatfilesize((float) (_size))+")... this will take a while please standby."));
 //BA.debugLineNum = 512;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_ass";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_black_36dp.png").getObject()));
 //BA.debugLineNum = 513;BA.debugLine="Builder.Initialize(\"exap\")";
_builder.Initialize(mostCurrent.activityBA,"exap");
 //BA.debugLineNum = 514;BA.debugLine="Builder.Title(\"Backup All:\").TitleColor(mcl.md_bl";
_builder.Title(BA.ObjectToCharSequence("Backup All:")).TitleColor(mostCurrent._mcl.getmd_black_1000()).TitleGravity(_builder.GRAVITY_START).Content(BA.ObjectToCharSequence(mostCurrent._label4.getText())).ContentColor(anywheresoftware.b4a.keywords.Common.Colors.DarkGray).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).Build();
 //BA.debugLineNum = 515;BA.debugLine="Builder.progress2(False,maxs,True)";
_builder.Progress2(anywheresoftware.b4a.keywords.Common.False,_maxs,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 517;BA.debugLine="exa.Enabled=True";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 518;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 519;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
String _fname = "";
String _vers = "";
 //BA.debugLineNum = 1301;BA.debugLine="Sub ex_Tick";
 //BA.debugLineNum = 1302;BA.debugLine="Dim a1,a2,sum,it As Int";
_a1 = 0;
_a2 = 0;
_sum = 0;
_it = 0;
 //BA.debugLineNum = 1303;BA.debugLine="Dim p,s,b,fname,vers As String";
_p = "";
_s = "";
_b = "";
_fname = "";
_vers = "";
 //BA.debugLineNum = 1304;BA.debugLine="s=finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1305;BA.debugLine="fname=pak.GetApplicationLabel(s)";
_fname = _pak.GetApplicationLabel(_s);
 //BA.debugLineNum = 1306;BA.debugLine="vers=pak.GetVersionName(s)";
_vers = _pak.GetVersionName(_s);
 //BA.debugLineNum = 1307;BA.debugLine="p=GetParentPath(GetSourceDir(GetActivitiesInfo(s)";
_p = _getparentpath(_getsourcedir(_getactivitiesinfo(_s)));
 //BA.debugLineNum = 1308;BA.debugLine="b=GetFileName(GetSourceDir(GetActivitiesInfo(s)))";
_b = _getfilename(_getsourcedir(_getactivitiesinfo(_s)));
 //BA.debugLineNum = 1309;BA.debugLine="a1=File.Size(p,GetFileName(GetSourceDir(GetActivi";
_a1 = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_p,_getfilename(_getsourcedir(_getactivitiesinfo(_s)))));
 //BA.debugLineNum = 1310;BA.debugLine="sum=a1/1024/1024";
_sum = (int) (_a1/(double)1024/(double)1024);
 //BA.debugLineNum = 1312;BA.debugLine="If Not(pdia.IsShowing) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._pdia.IsShowing())) { 
 //BA.debugLineNum = 1313;BA.debugLine="ex.Enabled = False";
_ex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1314;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 1316;BA.debugLine="If pdia.CurrentProgress = pdia.MaxProgress-2 Then";
...
anywheresoftware.b4a.keywords.Common.File.Copy(_p,_b,mostCurrent._dir,_fname+"_"+_vers+".apk");};
 //BA.debugLineNum = 1317;BA.debugLine="If pdia.CurrentProgress = pdia.MaxProgress Then";
if (mostCurrent._pdia.getCurrentProgress()==mostCurrent._pdia.getMaxProgress()) { 
 //BA.debugLineNum = 1318;BA.debugLine="ex.Enabled = False";
_ex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1319;BA.debugLine="put_data";
_put_data();
 //BA.debugLineNum = 1320;BA.debugLine="pdia.Content = \"Done! Please wait..\"";
mostCurrent._pdia.setContent(BA.ObjectToCharSequence("Done! Please wait.."));
 //BA.debugLineNum = 1323;BA.debugLine="deldia.Dismiss";
mostCurrent._deldia.Dismiss();
 //BA.debugLineNum = 1325;BA.debugLine="StartActivity(swit)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._swit.getObject()));
 //BA.debugLineNum = 1326;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 1329;BA.debugLine="pdia.IncrementProgress(1)";
...
public static String  _exa_tick() throws Exception{
 //BA.debugLineNum = 524;BA.debugLine="Sub exa_Tick";
 //BA.debugLineNum = 525;BA.debugLine="If Not(deldia.IsShowing) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._deldia.IsShowing())) { 
 //BA.debugLineNum = 526;BA.debugLine="exa.Enabled = False";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 527;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 529;BA.debugLine="If deldia.CurrentProgress = deldia.MaxProgress Th";
if (mostCurrent._deldia.getCurrentProgress()==mostCurrent._deldia.getMaxProgress()) { 
 //BA.debugLineNum = 530;BA.debugLine="exa.Enabled = False";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 531;BA.debugLine="deldia.Content = \"Done! Please wait..\"";
mostCurrent._deldia.setContent(BA.ObjectToCharSequence("Done! Please wait.."));
 //BA.debugLineNum = 532;BA.debugLine="StartActivity(swit)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._swit.getObject()));
 //BA.debugLineNum = 533;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 534;BA.debugLine="Animator.setanimati(\"slide_from_left\",\"slide_to_";
mostCurrent._animator._setanimati(mostCurrent.activityBA,"slide_from_left","slide_to_left");
 }else {
 //BA.debugLineNum = 536;BA.debugLine="deldia.IncrementProgress(1)";
mostCurrent._deldia.IncrementProgress((int) (1));
 //BA.debugLineNum = 537;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 538;BA.debugLine="file_copy";
_file_copy();
 };
...
public static String  _exadia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 491;BA.debugLine="Sub exadia_ButtonPressed (Dialog As MaterialDialog";
 //BA.debugLineNum = 492;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 494;BA.debugLine="ProgressDialogShow(\"please wait...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("please wait..."));
 //BA.debugLineNum = 495;BA.debugLine="ex_start";
_ex_start();
 break; }
case 1: {
 //BA.debugLineNum = 497;BA.debugLine="ToastMessageShow(\"canceled\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled"),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 499;BA.debugLine="ToastMessageShow(\"canceled...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("canceled..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
int _i = 0;
 //BA.debugLineNum = 1453;BA.debugLine="Sub ExpandItem(pnl As Panel, ID As Object)";
 //BA.debugLineNum = 1454;BA.debugLine="Dim pnlDetails As Panel, lbl,iiv,update As Label";
...
_update = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1455;BA.debugLine="Dim cfont As Typeface=Typeface.LoadFromAssets(\"Op";
_cfont = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
_cfont.setObject((android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf")));
 //BA.debugLineNum = 1456;BA.debugLine="pnlDetails.Initialize(\"\")";
_pnldetails.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1457;BA.debugLine="pnlDetails.Elevation=5dip";
_pnldetails.setElevation((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 1458;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1459;BA.debugLine="lbl.TextColor = Colors.DarkGray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.DarkGray);
 //BA.debugLineNum = 1460;BA.debugLine="lbl.TextSize = 14";
_lbl.setTextSize((float) (14));
 //BA.debugLineNum = 1461;BA.debugLine="lbl.Typeface=cfont";
_lbl.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1462;BA.debugLine="iiv.Initialize(\"\")";
_iiv.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1463;BA.debugLine="iiv.TextSize=14";
_iiv.setTextSize((float) (14));
 //BA.debugLineNum = 1464;BA.debugLine="iiv.Typeface=cfont";
_iiv.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1465;BA.debugLine="iiv.TextColor=Colors.DarkGray";
_iiv.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.DarkGray);
 //BA.debugLineNum = 1466;BA.debugLine="update.Initialize(\"\")";
_update.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1467;BA.debugLine="update.Typeface=cfont";
_update.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1468;BA.debugLine="update.TextColor=mcl.md_blue_600";
_update.setTextColor(mostCurrent._mcl.getmd_blue_600());
 //BA.debugLineNum = 1469;BA.debugLine="update.TextSize=14";
_update.setTextSize((float) (14));
 //BA.debugLineNum = 1471;BA.debugLine="Dim butt,butt2,butt3 As ACButton";
...
_butt3 = new de.amberhome.objects.appcompat.ACButtonWrapper();
 //BA.debugLineNum = 1472;BA.debugLine="butt.Initialize(\"butt\")";
_butt.Initialize(mostCurrent.activityBA,"butt");
 //BA.debugLineNum = 1473;BA.debugLine="butt2.Initialize(\"butt2\")";
_butt2.Initialize(mostCurrent.activityBA,"butt2");
 //BA.debugLineNum = 1474;BA.debugLine="butt3.Initialize(\"butt3\")";
_butt3.Initialize(mostCurrent.activityBA,"butt3");
 //BA.debugLineNum = 1475;BA.debugLine="butt.Enabled=True";
_butt.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1476;BA.debugLine="butt2.Enabled=True";
_butt2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1477;BA.debugLine="butt3.Enabled=True";
_butt3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1478;BA.debugLine="butt.Visible=True";
_butt.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1479;BA.debugLine="butt.Typeface=cfont";
_butt.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1480;BA.debugLine="butt2.Typeface=cfont";
_butt2.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1481;BA.debugLine="butt3.Typeface=cfont";
_butt3.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1482;BA.debugLine="butt.TextSize=13";
_butt.setTextSize((float) (13));
 //BA.debugLineNum = 1483;BA.debugLine="butt2.TextSize=13";
_butt2.setTextSize((float) (13));
 //BA.debugLineNum = 1484;BA.debugLine="butt3.TextSize=13";
_butt3.setTextSize((float) (13));
 //BA.debugLineNum = 1485;BA.debugLine="butt.TextColor=mcl.md_white_1000";
_butt.setTextColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 1486;BA.debugLine="butt2.TextColor=Colors.black";
_butt2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1487;BA.debugLine="butt3.TextColor=Colors.black";
_butt3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1489;BA.debugLine="butt.Text=\"Backup\"";
_butt.setText(BA.ObjectToCharSequence("Backup"));
 //BA.debugLineNum = 1490;BA.debugLine="butt2.Text=\"Start\"";
_butt2.setText(BA.ObjectToCharSequence("Start"));
 //BA.debugLineNum = 1491;BA.debugLine="butt3.Text=\"Share\"";
_butt3.setText(BA.ObjectToCharSequence("Share"));
 //BA.debugLineNum = 1492;BA.debugLine="butt.ButtonColor=Colors.ARGB(185,25,118,210)";
_butt.setButtonColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (185),(int) (25),(int) (118),(int) (210)));
 //BA.debugLineNum = 1493;BA.debugLine="butt2.ButtonColor=Colors.ARGB(185,25,118,210)";
_butt2.setButtonColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (185),(int) (25),(int) (118),(int) (210)));
 //BA.debugLineNum = 1494;BA.debugLine="butt3.ButtonColor=Colors.ARGB(185,25,118,210)";
_butt3.setButtonColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (185),(int) (25),(int) (118),(int) (210)));
 //BA.debugLineNum = 1495;BA.debugLine="Dim ib As BitmapDrawable";
_ib = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 1496;BA.debugLine="ib.Initialize(TextToBitmap(Chr(0xE192),20))";
_ib.Initialize((android.graphics.Bitmap)(_texttobitmap(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xe192))),(float) (20)).getObject()));
 //BA.debugLineNum = 1497;BA.debugLine="Dim ibb As Label";
_ibb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1498;BA.debugLine="ibb.Initialize(\"\")";
_ibb.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1499;BA.debugLine="ibb.TextSize=16";
_ibb.setTextSize((float) (16));
 //BA.debugLineNum = 1500;BA.debugLine="ibb.Typeface=cfont";
_ibb.setTypeface((android.graphics.Typeface)(_cfont.getObject()));
 //BA.debugLineNum = 1501;BA.debugLine="ibb.Gravity=Gravity.LEFT";
_ibb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.LEFT);
 //BA.debugLineNum = 1502;BA.debugLine="ibb.TextColor=mcl.md_amber_700";
_ibb.setTextColor(mostCurrent._mcl.getmd_amber_700());
 //BA.debugLineNum = 1503;BA.debugLine="For i = 0 To extra.Size-1";
{
final int step48 = 1;
final int limit48 = (int) (mostCurrent._extra.getSize()-1);
_i = (int) (0) ;
for (;(step48 > 0 && _i <= limit48) || (step48 < 0 && _i >= limit48) ;_i = ((int)(0 + _i + step48))  ) {
 //BA.debugLineNum = 1504;BA.debugLine="If dtime.ContainsKey(ID) Then";
if (mostCurrent._dtime._containskey(BA.ObjectToString(_id))) { 
 //BA.debugLineNum = 1505;BA.debugLine="update.Text=\"Date/Time: \"&dtime.GetSimple(ID)";
_update.setText(BA.ObjectToCharSequence("Date/Time: "+mostCurrent._dtime._getsimple(BA.ObjectToString(_id))));
 //BA.debugLineNum = 1506;BA.debugLine="ibb.Text=\"Backup Info:\"";
_ibb.setText(BA.ObjectToCharSequence("Backup Info:"));
 //BA.debugLineNum = 1507;BA.debugLine="lbl.Text=\"size: \"&FormatFileSize(File.Size(GetP";
_lbl.setText(BA.ObjectToCharSequence("size: "+_formatfilesize((float) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(_id)))),_getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(_id)))))))));
 //BA.debugLineNum = 1508;BA.debugLine="iiv.Text=\"SD: \"&datas.GetSimple(\"0\")'GetParentP";
_iiv.setText(BA.ObjectToCharSequence("SD: "+mostCurrent._datas._getsimple("0")));
 }else {
 //BA.debugLineNum = 1510;BA.debugLine="update.Text=\"-/-\"";
_update.setText(BA.ObjectToCharSequence("-/-"));
 //BA.debugLineNum = 1511;BA.debugLine="iiv.Text=\"Folder: -/-\"";
_iiv.setText(BA.ObjectToCharSequence("Folder: -/-"));
 //BA.debugLineNum = 1512;BA.debugLine="ibb.Text=\"No Archived Backup found !\"";
_ibb.setText(BA.ObjectToCharSequence("No Archived Backup found !"));
 //BA.debugLineNum = 1513;BA.debugLine="lbl.Text=\"Size: -/-\"";
_lbl.setText(BA.ObjectToCharSequence("Size: -/-"));
 };
 //BA.debugLineNum = 1515;BA.debugLine="If ID =extra.Get(i) Then";
if ((_id).equals(mostCurrent._extra.Get(_i))) { 
 //BA.debugLineNum = 1516;BA.debugLine="finish.Clear";
mostCurrent._finish.Clear();
 //BA.debugLineNum = 1517;BA.debugLine="finish.Add(ID)";
mostCurrent._finish.Add(_id);
 //BA.debugLineNum = 1518;BA.debugLine="pnlDetails.AddView(ibb, 0dip, 0,pnl.Width-1dip,";
_pnldetails.AddView((android.view.View)(_ibb.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (0),(int) (_pnl.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 1519;BA.debugLine="pnlDetails.AddView(update, 0dip, ibb.Height+1di";
_pnldetails.AddView((android.view.View)(_update.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (_ibb.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (95),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1520;BA.debugLine="pnlDetails.AddView(lbl, 0dip, update.Height+ibb";
_pnldetails.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (_update.getHeight()+_ibb.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (95),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1521;BA.debugLine="pnlDetails.AddView(iiv, 0dip, update.Height+lbl";
_pnldetails.AddView((android.view.View)(_iiv.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (_update.getHeight()+_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (98),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (55)));
 //BA.debugLineNum = 1522;BA.debugLine="pnlDetails.AddView(butt2, 0dip, iiv.Height+lbl.";
_pnldetails.AddView((android.view.View)(_butt2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (_iiv.getHeight()+_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (45)));
 //BA.debugLineNum = 1523;BA.debugLine="pnlDetails.AddView(butt, 90dip, iiv.Height+lbl.";
_pnldetails.AddView((android.view.View)(_butt.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)),(int) (_iiv.getHeight()+_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (45)));
 //BA.debugLineNum = 1524;BA.debugLine="pnlDetails.AddView(butt3, 180dip, iiv.Height+lb";
_pnldetails.AddView((android.view.View)(_butt3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (180)),(int) (_iiv.getHeight()+_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (45)));
 };
 //BA.debugLineNum = 1526;BA.debugLine="lst.ExtendItem(ID, pnlDetails, 140dip)";
...
String _ffs = "";
 //BA.debugLineNum = 766;BA.debugLine="Sub explor_set";
 //BA.debugLineNum = 767;BA.debugLine="svList.SetVisibleAnimated(400,False)";
mostCurrent._svlist.SetVisibleAnimated((int) (400),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 768;BA.debugLine="dir =datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 769;BA.debugLine="ff.Initialize(Activity,dir,\".apk\", True, False, \"";
mostCurrent._ff._initialize(mostCurrent.activityBA,mostCurrent._activity,mostCurrent._dir,".apk",anywheresoftware.b4a.keywords.Common.True,anywheresoftware.b4a.keywords.Common.False,"Close");
 //BA.debugLineNum = 770;BA.debugLine="ff.Explorer2(False)";
mostCurrent._ff._explorer2(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 771;BA.debugLine="ff.FastScrollEnabled=True";
mostCurrent._ff._fastscrollenabled = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 772;BA.debugLine="Dim ffs As String";
_ffs = "";
 //BA.debugLineNum = 773;BA.debugLine="If Not (ff.Selection.Canceled Or ff.Selection.Cho";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._ff._selection.Canceled || (mostCurrent._ff._selection.ChosenFile).equals(""))) { 
 //BA.debugLineNum = 774;BA.debugLine="ffs= ff.Selection.ChosenFile.SubString2(0,ff.Sel";
_ffs = mostCurrent._ff._selection.ChosenFile.substring((int) (0),(int) (mostCurrent._ff._selection.ChosenFile.length()-4));
 //BA.debugLineNum = 775;BA.debugLine="finish.Clear";
mostCurrent._finish.Clear();
 //BA.debugLineNum = 776;BA.debugLine="finish.Add(ffs)";
mostCurrent._finish.Add((Object)(_ffs));
 //BA.debugLineNum = 777;BA.debugLine="dataliste.Clear";
mostCurrent._dataliste.Clear();
 //BA.debugLineNum = 778;BA.debugLine="dataliste.AddTwoLines2(ff.Selection.ChosenFile,f";
mostCurrent._dataliste.AddTwoLines2(BA.ObjectToCharSequence(mostCurrent._ff._selection.ChosenFile),BA.ObjectToCharSequence(mostCurrent._ff._selection.ChosenPath),(Object)("0"));
 //BA.debugLineNum = 779;BA.debugLine="dataliste.AddTwoLines2(\"Backup Folder:\",datas.Ge";
mostCurrent._dataliste.AddTwoLines2(BA.ObjectToCharSequence("Backup Folder:"),BA.ObjectToCharSequence(mostCurrent._datas._getsimple("0")),(Object)("1"));
 //BA.debugLineNum = 780;BA.debugLine="dataliste.AddTwoLines2(\"Last Backup:\",dtime.GetS";
mostCurrent._dataliste.AddTwoLines2(BA.ObjectToCharSequence("Last Backup:"),BA.ObjectToCharSequence(mostCurrent._dtime._getsimple(_ffs)),(Object)("2"));
 //BA.debugLineNum = 781;BA.debugLine="ex_pan";
_ex_pan();
 }else {
 //BA.debugLineNum = 783;BA.debugLine="svList.SetVisibleAnimated(400,True)";
mostCurrent._svlist.SetVisibleAnimated((int) (400),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 784;BA.debugLine="ToastMessageShow(\"closed\",False)";
...
public static String  _fc_newdata(byte[] _buffer) throws Exception{
 //BA.debugLineNum = 573;BA.debugLine="Sub fc_NewData (Buffer() As Byte)";
...
public static String  _fc_newstream(String _dir1,String _filename) throws Exception{
 //BA.debugLineNum = 576;BA.debugLine="Sub fc_NewStream (dir1 As String, FileName As Stri";
 //BA.debugLineNum = 580;BA.debugLine="File.Copy(dir1,FileName,dir1,FileName&\".apk\")";
...
String _version = "";
String _g = "";
 //BA.debugLineNum = 1176;BA.debugLine="Sub file_check";
 //BA.debugLineNum = 1177;BA.debugLine="Dim fname,version As String";
_fname = "";
_version = "";
 //BA.debugLineNum = 1178;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1179;BA.debugLine="For Each g As String In extra";
{
...
_g = BA.ObjectToString(group3.Get(index3));
 //BA.debugLineNum = 1180;BA.debugLine="fname=pak.GetApplicationLabel(g)";
_fname = _pak.GetApplicationLabel(_g);
 //BA.debugLineNum = 1181;BA.debugLine="version=pak.GetVersionName(g)";
_version = _pak.GetVersionName(_g);
 //BA.debugLineNum = 1182;BA.debugLine="If File.Exists(dir,fname&\"_\"&version&\".apk\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._dir,_fname+"_"+_version+".apk")) { 
 //BA.debugLineNum = 1183;BA.debugLine="If Not (dtime.ContainsKey(g)) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._dtime._containskey(_g))) { 
 //BA.debugLineNum = 1184;BA.debugLine="dtime.PutSimple(g,date&\" - \"&time)";
mostCurrent._dtime._putsimple(_g,(Object)(_date+" - "+_time));
 //BA.debugLineNum = 1185;BA.debugLine="Log(g&\" added\")";
anywheresoftware.b4a.keywords.Common.Log(_g+" added");
 //BA.debugLineNum = 1186;BA.debugLine="cbut.Checked=True";
mostCurrent._cbut.setChecked(anywheresoftware.b4a.keywords.Common.True);
 };
 };
 //BA.debugLineNum = 1189;BA.debugLine="If Not(File.Exists(dir,fname&\"_\"&version&\".apk\")";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._dir,_fname+"_"+_version+".apk"))) { 
 //BA.debugLineNum = 1190;BA.debugLine="If dtime.ContainsKey(g) Then";
if (mostCurrent._dtime._containskey(_g)) { 
 //BA.debugLineNum = 1191;BA.debugLine="dtime.Remove(g)";
mostCurrent._dtime._remove(_g);
 //BA.debugLineNum = 1192;BA.debugLine="Log(g&\" removed\")";
anywheresoftware.b4a.keywords.Common.Log(_g+" removed");
 //BA.debugLineNum = 1193;BA.debugLine="cbut.Checked=False";
mostCurrent._cbut.setChecked(anywheresoftware.b4a.keywords.Common.False);
 };
 };
 }
...
public static String  _file_clear() throws Exception{
anywheresoftware.b4a.objects.collections.List _dlist = null;
int _maxs = 0;
int _i = 0;
 //BA.debugLineNum = 690;BA.debugLine="Sub file_clear";
 //BA.debugLineNum = 691;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 692;BA.debugLine="Dim maxs As Int";
_maxs = 0;
 //BA.debugLineNum = 693;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 694;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 695;BA.debugLine="dlist=File.ListFiles(dir)";
_dlist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._dir);
 //BA.debugLineNum = 696;BA.debugLine="maxs=dlist.Size";
_maxs = _dlist.getSize();
 //BA.debugLineNum = 697;BA.debugLine="For i = 0 To dlist.Size-1";
{
final int step7 = 1;
final int limit7 = (int) (_dlist.getSize()-1);
_i = (int) (0) ;
for (;(step7 > 0 && _i <= limit7) || (step7 < 0 && _i >= limit7) ;_i = ((int)(0 + _i + step7))  ) {
 //BA.debugLineNum = 698;BA.debugLine="File.Delete(dir,dlist.Get(i))";
anywheresoftware.b4a.keywords.Common.File.Delete(mostCurrent._dir,BA.ObjectToString(_dlist.Get(_i)));
 //BA.debugLineNum = 699;BA.debugLine="Label4.Text=dlist.Get(i)";
mostCurrent._label4.setText(BA.ObjectToCharSequence(_dlist.Get(_i)));
 //BA.debugLineNum = 700;BA.debugLine="dtime.Remove(dlist.Get(i))";
mostCurrent._dtime._remove(BA.ObjectToString(_dlist.Get(_i)));
 //BA.debugLineNum = 701;BA.debugLine="bcount.Remove(dlist.Get(i))";
mostCurrent._bcount._remove(BA.ObjectToString(_dlist.Get(_i)));
 //BA.debugLineNum = 702;BA.debugLine="file_check";
_file_check();
 }
};
...
int _h = 0;
 //BA.debugLineNum = 542;BA.debugLine="Sub file_copy";
 //BA.debugLineNum = 544;BA.debugLine="Dim a1,a2,sum,it As Int";
_a1 = 0;
_a2 = 0;
_sum = 0;
_it = 0;
 //BA.debugLineNum = 545;BA.debugLine="Dim p,s,b,fname,vers As String";
_p = "";
_s = "";
_b = "";
_fname = "";
_vers = "";
 //BA.debugLineNum = 546;BA.debugLine="Dim buf() As Byte";
_buf = new byte[(int) (0)];
;
 //BA.debugLineNum = 547;BA.debugLine="Dim out As OutputStream";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 548;BA.debugLine="out.InitializeToBytesArray(0)";
_out.InitializeToBytesArray((int) (0));
 //BA.debugLineNum = 549;BA.debugLine="Dim inn As InputStream";
_inn = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 550;BA.debugLine="For  h = 0 To  exalist.Size-1";
{
final int step7 = 1;
final int limit7 = (int) (mostCurrent._exalist.getSize()-1);
_h = (int) (0) ;
for (;(step7 > 0 && _h <= limit7) || (step7 < 0 && _h >= limit7) ;_h = ((int)(0 + _h + step7))  ) {
 //BA.debugLineNum = 551;BA.debugLine="dtime.PutSimple(exalist.Get(h),date&\" - \"&time)";
mostCurrent._dtime._putsimple(BA.ObjectToString(mostCurrent._exalist.Get(_h)),(Object)(_date+" - "+_time));
 //BA.debugLineNum = 552;BA.debugLine="s=exalist.Get(h)";
_s = BA.ObjectToString(mostCurrent._exalist.Get(_h));
 //BA.debugLineNum = 553;BA.debugLine="fname=pak.GetApplicationLabel(s)";
_fname = _pak.GetApplicationLabel(_s);
 //BA.debugLineNum = 554;BA.debugLine="vers=pak.GetVersionName(s)";
_vers = _pak.GetVersionName(_s);
 //BA.debugLineNum = 555;BA.debugLine="p=GetParentPath(GetSourceDir(GetActivitiesInfo(s";
_p = _getparentpath(_getsourcedir(_getactivitiesinfo(_s)));
 //BA.debugLineNum = 556;BA.debugLine="b=GetFileName(GetSourceDir(GetActivitiesInfo(s))";
_b = _getfilename(_getsourcedir(_getactivitiesinfo(_s)));
 //BA.debugLineNum = 558;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 559;BA.debugLine="size= File.Size(GetParentPath(GetSourceDir(GetAc";
_size = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._exalist.Get(_h))))),_getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._exalist.Get(_h)))))));
 //BA.debugLineNum = 560;BA.debugLine="If Not(File.Exists(dir,fname&\"_\"&vers&\".apk\")) T";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._dir,_fname+"_"+_vers+".apk"))) { 
 //BA.debugLineNum = 561;BA.debugLine="dtime.DeleteAll";
mostCurrent._dtime._deleteall();
 //BA.debugLineNum = 562;BA.debugLine="File.Copy(p,b,dir,fname&\"_\"&vers&\".apk\")";
anywheresoftware.b4a.keywords.Common.File.Copy(_p,_b,mostCurrent._dir,_fname+"_"+_vers+".apk");
 //BA.debugLineNum = 564;BA.debugLine="deldia.Content=\"copying...\"&fname&\"_\"&vers&\".ap";
mostCurrent._deldia.setContent(BA.ObjectToCharSequence("copying..."+_fname+"_"+_vers+".apk"));
 }else {
 //BA.debugLineNum = 566;BA.debugLine="For Each b As String In exalist";
{
final anywheresoftware.b4a.BA.IterableList group21 = mostCurrent._exalist;
final int groupLen21 = group21.getSize()
;int index21 = 0;
;
for (; index21 < groupLen21;index21++){
_b = BA.ObjectToString(group21.Get(index21));
 //BA.debugLineNum = 567;BA.debugLine="deldia.Content=\"file exist\"&b";
mostCurrent._deldia.setContent(BA.ObjectToCharSequence("file exist"+_b));
 }
};
 };
 }
...
public static String  _fold_set() throws Exception{
 //BA.debugLineNum = 901;BA.debugLine="Sub fold_set";
 //BA.debugLineNum = 902;BA.debugLine="explor_set";
_explor_set();
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 1589;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 1591;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 1593;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 1594;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 1596;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 1597;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 1598;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 1599;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 1600;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 1601;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 1602;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1647;BA.debugLine="Sub get_respath(package As String) As Object";
 //BA.debugLineNum = 1648;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1649;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 1650;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 1651;BA.debugLine="r.Target = r.RunMethod3(\"getApplicationInfo\", pac";
_r.Target = _r.RunMethod3("getApplicationInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 1652;BA.debugLine="Return r.GetField(\"dataDir\")";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1629;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 1630;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1631;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 1632;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 1633;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 1634;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
public static String  _getfilename(String _fullpath) throws Exception{
 //BA.debugLineNum = 1606;BA.debugLine="Sub GetFileName(FullPath As String) As String";
 //BA.debugLineNum = 1607;BA.debugLine="Return FullPath.SubString(FullPath.LastIndexOf(\"/";
...
String _path1 = "";
 //BA.debugLineNum = 1611;BA.debugLine="Sub GetParentPath(path As String) As String";
 //BA.debugLineNum = 1612;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 1613;BA.debugLine="If path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 1614;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 1616;BA.debugLine="L = path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 1617;BA.debugLine="If L = path.Length - 1 Then";
if ((mostCurrent._l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 1618;BA.debugLine="Path1 = path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(mostCurrent._l)));
 }else {
 //BA.debugLineNum = 1620;BA.debugLine="Path1 = path";
_path1 = _path;
 };
 //BA.debugLineNum = 1622;BA.debugLine="L = path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 1623;BA.debugLine="If L = 0 Then";
if ((mostCurrent._l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 1624;BA.debugLine="L = 1";
mostCurrent._l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 1626;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1637;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 1638;BA.debugLine="Try";
try { //BA.debugLineNum = 1639;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1640;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 1641;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 1643;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
public static String  _idia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 961;BA.debugLine="Sub idia_ButtonPressed (Dialog As MaterialDialog,";
 //BA.debugLineNum = 962;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 964;BA.debugLine="Dialog.Dismiss";
_dialog.Dismiss();
 //BA.debugLineNum = 965;BA.debugLine="zip_pan";
_zip_pan();
 break; }
case 1: {
 break; }
case 2: {
 //BA.debugLineNum = 970;BA.debugLine="Dialog.Dismiss";
_dialog.Dismiss();
 break; }
}
;
...
public static String  _idia_simpleitemselected(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,int _position,de.amberhome.materialdialogs.MaterialSimpleListItemWrapper _item) throws Exception{
 //BA.debugLineNum = 936;BA.debugLine="Sub idia_SimpleItemSelected (Dialog As MaterialDia";
 //BA.debugLineNum = 937;BA.debugLine="If Position=Item.id Then";
if (_position==_item.getId()) { 
 //BA.debugLineNum = 938;BA.debugLine="finish.Clear";
mostCurrent._finish.Clear();
 //BA.debugLineNum = 939;BA.debugLine="finish.Add(Item.Content.SubString2(0,Item.Conte";
mostCurrent._finish.Add((Object)(_item.getContent().substring((int) (0),(int) (_item.getContent().length()-4))));
 //BA.debugLineNum = 940;BA.debugLine="ToastMessageShow(Item.Content.SubString2(0,Item.";
...
String _d2 = "";
String _master = "";
 //BA.debugLineNum = 1102;BA.debugLine="Sub ini_extract";
 //BA.debugLineNum = 1103;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1105;BA.debugLine="Dim b As String = GetFileName(GetSourceDir(GetAct";
_b = _getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))));
 //BA.debugLineNum = 1106;BA.debugLine="Dim p As String =  GetParentPath(get_respath(fini";
_p = _getparentpath(BA.ObjectToString(_get_respath(BA.ObjectToString(mostCurrent._finish.Get((int) (0))))));
 //BA.debugLineNum = 1108;BA.debugLine="name1=b";
mostCurrent._name1 = _b;
 //BA.debugLineNum = 1109;BA.debugLine="Label4.text=name1";
mostCurrent._label4.setText(BA.ObjectToCharSequence(mostCurrent._name1));
 //BA.debugLineNum = 1110;BA.debugLine="Dim d1,d2,master As String";
_d1 = "";
_d2 = "";
_master = "";
 //BA.debugLineNum = 1111;BA.debugLine="d1=File.DirRootExternal&\"/APEX\"";
_d1 = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/APEX";
 //BA.debugLineNum = 1112;BA.debugLine="d2=datas.GetSimple(\"0\")";
_d2 = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1113;BA.debugLine="If datas.ContainsKey(\"0\") Then";
if (mostCurrent._datas._containskey("0")) { 
 //BA.debugLineNum = 1114;BA.debugLine="master=d2";
_master = _d2;
 }else {
 //BA.debugLineNum = 1116;BA.debugLine="master=d1";
_master = _d1;
 };
 //BA.debugLineNum = 1119;BA.debugLine="If File.Exists(master,s&\".apk\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(_master,_s+".apk")) { 
 //BA.debugLineNum = 1120;BA.debugLine="put_data";
_put_data();
 //BA.debugLineNum = 1121;BA.debugLine="int_folder";
_int_folder();
 }else {
 //BA.debugLineNum = 1125;BA.debugLine="cop.DeleteAll";
mostCurrent._cop._deleteall();
 //BA.debugLineNum = 1126;BA.debugLine="cop.PutSimple(\"1\",p)";
mostCurrent._cop._putsimple("1",(Object)(_p));
 //BA.debugLineNum = 1127;BA.debugLine="cop.PutSimple(\"2\",s)";
mostCurrent._cop._putsimple("2",(Object)(_s));
 //BA.debugLineNum = 1128;BA.debugLine="cop.PutSimple(\"3\",b)";
mostCurrent._cop._putsimple("3",(Object)(_b));
 //BA.debugLineNum = 1129;BA.debugLine="put_data";
_put_data();
 //BA.debugLineNum = 1130;BA.debugLine="ex_pan2";
_ex_pan2();
 };
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
 //BA.debugLineNum = 1213;BA.debugLine="Sub int_folder";
 //BA.debugLineNum = 1214;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1215;BA.debugLine="pnl.Initialize(\"\")";
_pnl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1216;BA.debugLine="Dim d1,d2,master As String";
_d1 = "";
_d2 = "";
_master = "";
 //BA.debugLineNum = 1217;BA.debugLine="d1=File.DirRootExternal&\"/APEX\"";
_d1 = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/APEX";
 //BA.debugLineNum = 1218;BA.debugLine="d2=datas.GetSimple(\"0\")";
_d2 = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1219;BA.debugLine="Dim sf As Label";
_sf = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1220;BA.debugLine="sf.Initialize(\"\")";
_sf.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1221;BA.debugLine="For Each s As String In finish";
{
...
_s = BA.ObjectToString(group8.Get(index8));
 //BA.debugLineNum = 1222;BA.debugLine="sf=pnl.GetView(s)";
_sf.setObject((android.widget.TextView)(_pnl.GetView((int)(Double.parseDouble(_s))).getObject()));
 }
};
 //BA.debugLineNum = 1224;BA.debugLine="If datas.ContainsKey(\"0\") Then";
if (mostCurrent._datas._containskey("0")) { 
 //BA.debugLineNum = 1225;BA.debugLine="master=d2";
_master = _d2;
 };
 //BA.debugLineNum = 1227;BA.debugLine="Dim error As String =\"Backup found!\"";
_error = "Backup found!";
 //BA.debugLineNum = 1228;BA.debugLine="Dim errorc As String =master";
_errorc = _master;
 //BA.debugLineNum = 1229;BA.debugLine="Dim errorb,errord As Label";
_errorb = new anywheresoftware.b4a.objects.LabelWrapper();
_errord = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1230;BA.debugLine="errorb.Initialize(\"errorb\")";
_errorb.Initialize(mostCurrent.activityBA,"errorb");
 //BA.debugLineNum = 1231;BA.debugLine="errord.Initialize(\"errord\")";
_errord.Initialize(mostCurrent.activityBA,"errord");
 //BA.debugLineNum = 1232;BA.debugLine="errorb.Text=error";
_errorb.setText(BA.ObjectToCharSequence(_error));
 //BA.debugLineNum = 1233;BA.debugLine="errord.Text=errorc";
_errord.setText(BA.ObjectToCharSequence(_errorc));
 //BA.debugLineNum = 1234;BA.debugLine="errorb.Gravity=Gravity.FILL";
_errorb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 1235;BA.debugLine="errorb.TextColor=mcl.md_black_1000";
_errorb.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 1236;BA.debugLine="errorb.TextSize=17";
_errorb.setTextSize((float) (17));
 //BA.debugLineNum = 1237;BA.debugLine="icon=pak.GetApplicationIcon(s)";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(_s)));
 //BA.debugLineNum = 1238;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 1239;BA.debugLine="Builder.Initialize(\"intdia\")";
_builder.Initialize(mostCurrent.activityBA,"intdia");
 //BA.debugLineNum = 1240;BA.debugLine="Builder.Title(\"APK Info\").TitleColor(mcl.md_black";
_builder.Title(BA.ObjectToCharSequence("APK Info")).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_errorb.getText()+","+_errord.getText()+_s+".apk")).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.True).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Ok")).PositiveColor(mostCurrent._mcl.getmd_amber_900()).NeutralText(BA.ObjectToCharSequence("")).NeutralColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 1241;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 1242;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
int _i = 0;
 //BA.debugLineNum = 906;BA.debugLine="Sub item_show";
 //BA.debugLineNum = 907;BA.debugLine="Dim ico As BitmapDrawable";
_ico = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 908;BA.debugLine="Dim imi As MaterialSimpleListItem";
_imi = new de.amberhome.materialdialogs.MaterialSimpleListItemWrapper();
 //BA.debugLineNum = 909;BA.debugLine="Dim dlab,dcont As Label";
_dlab = new anywheresoftware.b4a.objects.LabelWrapper();
_dcont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 910;BA.debugLine="dlab.Initialize(\"\")";
_dlab.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 911;BA.debugLine="dcont.Initialize(\"\")";
_dcont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 912;BA.debugLine="dlab.TextSize=15";
_dlab.setTextSize((float) (15));
 //BA.debugLineNum = 913;BA.debugLine="dcont.TextSize=14";
_dcont.setTextSize((float) (14));
 //BA.debugLineNum = 914;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 915;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 916;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 918;BA.debugLine="dlist=File.ListFiles(dir)";
_dlist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._dir);
 //BA.debugLineNum = 919;BA.debugLine="dlab.Text=\"Backup Archive:\"";
_dlab.setText(BA.ObjectToCharSequence("Backup Archive:"));
 //BA.debugLineNum = 920;BA.debugLine="dcont.Text=dlist.size&\" apk´s\"";
_dcont.setText(BA.ObjectToCharSequence(BA.NumberToString(_dlist.getSize())+" apk´s"));
 //BA.debugLineNum = 921;BA.debugLine="ico.Initialize(LoadBitmap(File.DirAssets,\"ic_sd_s";
_ico.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sd_storage_black_36dp.png").getObject()));
 //BA.debugLineNum = 922;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_ass";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_turned_in_black_24dp.png").getObject()));
 //BA.debugLineNum = 923;BA.debugLine="icon.Gravity=Gravity.CENTER";
mostCurrent._icon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 924;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 925;BA.debugLine="Builder.Initialize(\"idia\")";
_builder.Initialize(mostCurrent.activityBA,"idia");
 //BA.debugLineNum = 926;BA.debugLine="Builder.Title(dlab.text).TitleColor(mcl.md_black_";
_builder.Title(BA.ObjectToCharSequence(_dlab.getText())).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(_ico.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_dcont.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.True).AutoDismiss(anywheresoftware.b4a.keywords.Common.False).NeutralText(BA.ObjectToCharSequence("Ok")).NeutralColor(mostCurrent._mcl.getmd_black_1000()).PositiveText(BA.ObjectToCharSequence("Zip Archive")).ItemsCallback().AlwaysCallSingleChoiceCallback();
 //BA.debugLineNum = 927;BA.debugLine="For  i =0 To  dlist.Size-1";
{
final int step20 = 1;
final int limit20 = (int) (_dlist.getSize()-1);
_i = (int) (0) ;
for (;(step20 > 0 && _i <= limit20) || (step20 < 0 && _i >= limit20) ;_i = ((int)(0 + _i + step20))  ) {
 //BA.debugLineNum = 928;BA.debugLine="imi.Initialize(icon,dlist.Get(i))";
_imi.Initialize(processBA,(android.graphics.drawable.Drawable)(mostCurrent._icon.getObject()),BA.ObjectToCharSequence(_dlist.Get(_i)));
 //BA.debugLineNum = 929;BA.debugLine="Builder.AddSimpleItem(imi)";
_builder.AddSimpleItem(_imi);
 //BA.debugLineNum = 930;BA.debugLine="imi.Id=i";
_imi.setId((long) (_i));
 }
};
 //BA.debugLineNum = 932;BA.debugLine="Builder.ItemsCallbacksingleChoice(Builder.SimpleI";
_builder.ItemsCallbackSingleChoice(_builder.getSimpleItemCount()).LimitIconToDefaultSize();
 //BA.debugLineNum = 933;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 934;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 1531;BA.debugLine="Sub lst_Click(pnl As Panel, ID As Object)";
 //BA.debugLineNum = 1532;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1533;BA.debugLine="lbl = pnl.GetView(1)";
_lbl.setObject((android.widget.TextView)(_pnl.GetView((int) (1)).getObject()));
 //BA.debugLineNum = 1534;BA.debugLine="If lst.HasExtraContent And lst.ExtendedItemID = I";
if (mostCurrent._lst._hasextracontent() && (mostCurrent._lst._extendeditemid()).equals(_id)) { 
 //BA.debugLineNum = 1536;BA.debugLine="lst.CollapseItem";
mostCurrent._lst._collapseitem();
 }else {
 //BA.debugLineNum = 1540;BA.debugLine="ExpandItem(pnl, ID)";
_expanditem(_pnl,_id);
 };
 //BA.debugLineNum = 1542;BA.debugLine="finish.Clear";
mostCurrent._finish.Clear();
 //BA.debugLineNum = 1543;BA.debugLine="finish.Add(ID)";
mostCurrent._finish.Add(_id);
...
public static String  _lvmenu_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 395;BA.debugLine="Sub lvmenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 396;BA.debugLine="Select Value";
switch (BA.switchObjectToInt(_value,(Object)("0"),(Object)("1"),(Object)("2"),(Object)("3"))) {
case 0: {
 //BA.debugLineNum = 398;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 399;BA.debugLine="item_show";
_item_show();
 break; }
case 1: {
 //BA.debugLineNum = 402;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 403;BA.debugLine="pre_start";
_pre_start();
 break; }
case 2: {
 //BA.debugLineNum = 405;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 406;BA.debugLine="del_dia";
_del_dia();
 break; }
case 3: {
 //BA.debugLineNum = 408;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 409;BA.debugLine="sm.ShowSecondaryMenu";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _eim = null;
anywheresoftware.b4a.objects.drawable.BitmapDrawable _climg = null;
 //BA.debugLineNum = 332;BA.debugLine="Sub menu_three";
 //BA.debugLineNum = 333;BA.debugLine="Dim font As Typeface=Typeface.LoadFromAssets(\"Ope";
_font = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
_font.setObject((android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("OpenSans.ttf")));
 //BA.debugLineNum = 334;BA.debugLine="rftext.Typeface=font";
mostCurrent._rftext.setTypeface((android.graphics.Typeface)(_font.getObject()));
 //BA.debugLineNum = 335;BA.debugLine="rftext.Text=\"FileWatcher Service coming up next V";
mostCurrent._rftext.setText(BA.ObjectToCharSequence("FileWatcher Service coming up next Version.."));
 //BA.debugLineNum = 336;BA.debugLine="rftext.TextSize=12";
mostCurrent._rftext.setTextSize((float) (12));
 //BA.debugLineNum = 337;BA.debugLine="Dim fim,him,eim As Bitmap";
_fim = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_him = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_eim = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 338;BA.debugLine="Dim climg As BitmapDrawable";
_climg = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 339;BA.debugLine="fim.Initialize(File.DirAssets,\"ic_label_white_36d";
_fim.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_label_white_36dp.png");
 //BA.debugLineNum = 340;BA.debugLine="climg.Initialize(LoadBitmap(File.DirAssets,\"ic_fo";
_climg.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_folder_open_white_36dp.png").getObject()));
 //BA.debugLineNum = 341;BA.debugLine="eim.Initialize(File.DirAssets,\"ic_share_white_36d";
_eim.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_share_white_36dp.png");
 //BA.debugLineNum = 342;BA.debugLine="him.Initialize(File.DirAssets,\"ic_info_outline_wh";
_him.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_info_outline_white_36dp.png");
 //BA.debugLineNum = 343;BA.debugLine="rvmenu.Clear";
mostCurrent._rvmenu.Clear();
 //BA.debugLineNum = 344;BA.debugLine="rvmenu.AddTwoLinesAndBitmap2(\"Share\",\"Share \"&pak";
mostCurrent._rvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Share"),BA.ObjectToCharSequence("Share "+_pak.GetApplicationLabel("com.apkbackup.de")),(android.graphics.Bitmap)(_eim.getObject()),(Object)("0"));
 //BA.debugLineNum = 345;BA.debugLine="rvmenu.AddTwoLinesAndBitmap2(\"Help\",\"FAQ and rece";
mostCurrent._rvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Help"),BA.ObjectToCharSequence("FAQ and recent Info´s"),(android.graphics.Bitmap)(_fim.getObject()),(Object)("1"));
 //BA.debugLineNum = 346;BA.debugLine="rvmenu.AddTwoLinesAndBitmap2(\"About\",\"APK Backup(";
mostCurrent._rvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("About"),BA.ObjectToCharSequence("APK Backup(Pro) version etc.."),(android.graphics.Bitmap)(_him.getObject()),(Object)("2"));
 //BA.debugLineNum = 347;BA.debugLine="dir=File.dirrootexternal&\"/APEX/backups\"";
mostCurrent._dir = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/APEX/backups";
 //BA.debugLineNum = 348;BA.debugLine="If datas.ContainsKey(\"0\") Then";
if (mostCurrent._datas._containskey("0")) { 
 //BA.debugLineNum = 349;BA.debugLine="acp.Add2(datas.GetSimple(\"0\"),climg)";
mostCurrent._acp.Add2(BA.ObjectToCharSequence(mostCurrent._datas._getsimple("0")),(android.graphics.drawable.Drawable)(_climg.getObject()));
 ...
 //BA.debugLineNum = 351;BA.debugLine="datas.PutSimple(\"0\",dir)";
mostCurrent._datas._putsimple("0",(Object)(mostCurrent._dir));
 //BA.debugLineNum = 352;BA.debugLine="acp.Add2(dir,climg)";
...
public static String  _menu_two() throws Exception{
 //BA.debugLineNum = 323;BA.debugLine="Sub menu_two";
 //BA.debugLineNum = 324;BA.debugLine="lvMenu.Clear";
mostCurrent._lvmenu.Clear();
 //BA.debugLineNum = 325;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Explorer\",\"explore";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Explorer"),BA.ObjectToCharSequence("explore your backuped App´s"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_folder_open_white_36dp.png").getObject()),(Object)("0"));
 //BA.debugLineNum = 326;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Backup all..\",\"expo";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Backup all.."),BA.ObjectToCharSequence("export all user apps at once"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_cached_white_36dp.png").getObject()),(Object)("1"));
 //BA.debugLineNum = 327;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Delete Backup´s..\",";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Delete Backup´s.."),BA.ObjectToCharSequence("deletes all backup files"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_block_white_36dp.png").getObject()),(Object)("2"));
 //BA.debugLineNum = 328;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Settings\",\"open the";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Settings"),BA.ObjectToCharSequence("open the Main-settings"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_exit_to_app_white_48dp.png").getObject()),(Object)("3"));
 //BA.debugLineNum = 329;BA.debugLine="menu_three";
_menu_three();
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return "";
}
public static String  _menulist_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 760;BA.debugLine="Sub menulist_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 761;BA.debugLine="If Position=1 Then";
if (_position==1) { 
 //BA.debugLineNum = 762;BA.debugLine="explor_set";
_explor_set();
 };
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 1581;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 1582;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 1583;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 1584;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 1585;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 1586;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
...
public static String  _otb_navigationitemclick() throws Exception{
 //BA.debugLineNum = 419;BA.debugLine="Sub otb_NavigationItemClick";
 //BA.debugLineNum = 420;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
...
public static String  _paint_pan(anywheresoftware.b4a.objects.PanelWrapper _pnl,int _state) throws Exception{
 //BA.debugLineNum = 1440;BA.debugLine="Sub paint_pan(pnl As Panel,State As Int)";
 //BA.debugLineNum = 1441;BA.debugLine="Select State";
switch (_state) {
case 0: 
case 1: {
 //BA.debugLineNum = 1443;BA.debugLine="pnl.Color = Colors.ARGB(120,255,255,255)";
_pnl.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (120),(int) (255),(int) (255),(int) (255)));
 break; }
case 2: 
case 3: {
 //BA.debugLineNum = 1445;BA.debugLine="pnl.Color =Colors.ARGB(110,139,195,74)";
_pnl.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (110),(int) (139),(int) (195),(int) (74)));
 break; }
case 4: {
 //BA.debugLineNum = 1447;BA.debugLine="pnl.Color =Colors.ARGB(120,108,113,109)";
_pnl.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (120),(int) (108),(int) (113),(int) (109)));
 break; }
}
;
 //BA.debugLineNum = 1450;BA.debugLine="Return pnl";
...
String _fullpath = "";
 //BA.debugLineNum = 1571;BA.debugLine="Sub pak_info(path As String)";
 //BA.debugLineNum = 1572;BA.debugLine="Dim r, r2 As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
_r2 = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1573;BA.debugLine="Dim fullpath As String";
_fullpath = "";
 //BA.debugLineNum = 1574;BA.debugLine="fullpath =path";
_fullpath = _path;
 //BA.debugLineNum = 1575;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 1576;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 1577;BA.debugLine="r2.Target = r.RunMethod3(\"getPackageArchiveInfo\",";
...
String _ffs = "";
 //BA.debugLineNum = 605;BA.debugLine="Sub path_explorer";
 //BA.debugLineNum = 606;BA.debugLine="svList.SetVisibleAnimated(400,False)";
mostCurrent._svlist.SetVisibleAnimated((int) (400),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 607;BA.debugLine="ff.Initialize(Activity,File.DirRootExternal,\"*.*\"";
mostCurrent._ff._initialize(mostCurrent.activityBA,mostCurrent._activity,anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"*.*",anywheresoftware.b4a.keywords.Common.True,anywheresoftware.b4a.keywords.Common.True,"Select");
 //BA.debugLineNum = 608;BA.debugLine="ff.Explorer2(False)";
mostCurrent._ff._explorer2(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 609;BA.debugLine="ff.FastScrollEnabled=True";
mostCurrent._ff._fastscrollenabled = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 610;BA.debugLine="Dim ffs As String";
_ffs = "";
 //BA.debugLineNum = 611;BA.debugLine="icon.Initialize(LoadBitmap(File.DirAssets,\"ic_fin";
mostCurrent._icon.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_find_in_page_black_36dp.png").getObject()));
 //BA.debugLineNum = 612;BA.debugLine="If  Not(ff.Selection.Canceled Or ff.Selection.Cho";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._ff._selection.Canceled || (mostCurrent._ff._selection.ChosenPath).equals(""))) { 
 //BA.debugLineNum = 614;BA.debugLine="datas.DeleteAll";
mostCurrent._datas._deleteall();
 //BA.debugLineNum = 615;BA.debugLine="datas.PutSimple(\"0\",ff.Selection.ChosenPath)";
mostCurrent._datas._putsimple("0",(Object)(mostCurrent._ff._selection.ChosenPath));
 //BA.debugLineNum = 616;BA.debugLine="ToastMessageShow(ff.Selection.ChosenPath,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._ff._selection.ChosenPath),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 617;BA.debugLine="svList.SetVisibleAnimated(400,True)";
mostCurrent._svlist.SetVisibleAnimated((int) (400),anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 619;BA.debugLine="datas.DeleteAll";
mostCurrent._datas._deleteall();
 //BA.debugLineNum = 620;BA.debugLine="datas.PutSimple(\"0\",dir)";
mostCurrent._datas._putsimple("0",(Object)(mostCurrent._dir));
 //BA.debugLineNum = 621;BA.debugLine="svList.SetVisibleAnimated(400,True)";
mostCurrent._svlist.SetVisibleAnimated((int) (400),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 622;BA.debugLine="ToastMessageShow(\"closed\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("closed"),anywheresoftware.b4a.keywords.Common.False);
 };
...
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
int _i = 0;
 //BA.debugLineNum = 460;BA.debugLine="Sub pre_start";
 //BA.debugLineNum = 461;BA.debugLine="Dim imi As MaterialSimpleListItem";
_imi = new de.amberhome.materialdialogs.MaterialSimpleListItemWrapper();
 //BA.debugLineNum = 462;BA.debugLine="Dim ico As BitmapDrawable";
_ico = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 463;BA.debugLine="ico.Initialize(LoadBitmap(File.DirAssets,\"ic_now_";
_ico.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_now_widgets_black_18dp.png").getObject()));
 //BA.debugLineNum = 464;BA.debugLine="Dim dlab,dcont As Label";
_dlab = new anywheresoftware.b4a.objects.LabelWrapper();
_dcont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 466;BA.debugLine="dlab.Initialize(\"\")";
_dlab.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 467;BA.debugLine="dcont.Initialize(\"\")";
_dcont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 468;BA.debugLine="dlab.TextSize=15";
_dlab.setTextSize((float) (15));
 //BA.debugLineNum = 469;BA.debugLine="dcont.TextSize=14";
_dcont.setTextSize((float) (14));
 //BA.debugLineNum = 470;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 471;BA.debugLine="dlab.Text=\"Backup\"";
_dlab.setText(BA.ObjectToCharSequence("Backup"));
 //BA.debugLineNum = 473;BA.debugLine="icon.Gravity=Gravity.FILL";
mostCurrent._icon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 474;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 475;BA.debugLine="exalist.Clear";
mostCurrent._exalist.Clear();
 //BA.debugLineNum = 476;BA.debugLine="Builder.Initialize(\"exadia\")";
_builder.Initialize(mostCurrent.activityBA,"exadia");
 //BA.debugLineNum = 477;BA.debugLine="For i=0 To extra.Size-1";
{
final int step15 = 1;
final int limit15 = (int) (mostCurrent._extra.getSize()-1);
_i = (int) (0) ;
for (;(step15 > 0 && _i <= limit15) || (step15 < 0 && _i >= limit15) ;_i = ((int)(0 + _i + step15))  ) {
 //BA.debugLineNum = 478;BA.debugLine="exalist.Add(extra.Get(i))";
mostCurrent._exalist.Add(mostCurrent._extra.Get(_i));
 //BA.debugLineNum = 479;BA.debugLine="size= File.Size(GetParentPath(GetSourceDir(GetAc";
_size = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._extra.Get(_i))))),_getfilename(_getsourcedir(_getactivitiesinfo(BA.ObjectToString(mostCurrent._extra.Get(_i)))))));
 //BA.debugLineNum = 480;BA.debugLine="icon=pak.GetApplicationIcon(extra.Get(i))";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(BA.ObjectToString(mostCurrent._extra.Get(_i)))));
 //BA.debugLineNum = 481;BA.debugLine="packName=extra.Get(i)";
mostCurrent._packname = BA.ObjectToString(mostCurrent._extra.Get(_i));
 //BA.debugLineNum = 482;BA.debugLine="imi.Initialize(icon,pak.GetApplicationLabel(extr";
_imi.Initialize(processBA,(android.graphics.drawable.Drawable)(mostCurrent._icon.getObject()),BA.ObjectToCharSequence(_pak.GetApplicationLabel(BA.ObjectToString(mostCurrent._extra.Get(_i)))+" - "+_formatfilesize((float) (_size))));
 //BA.debugLineNum = 483;BA.debugLine="Builder.AddSimpleItem(imi)";
_builder.AddSimpleItem(_imi);
 //BA.debugLineNum = 484;BA.debugLine="dcont.Text=\"Backup all unsaved App´s at once..(\"";
_dcont.setText(BA.ObjectToCharSequence("Backup all unsaved App´s at once..("+_formatfilesize((float) (_size*1024*10))+")"));
 }
};
 //BA.debugLineNum = 486;BA.debugLine="Builder.Title(dlab.text).TitleColor(mcl.md_black_";
_builder.Title(BA.ObjectToCharSequence(_dlab.getText())).TitleColor(mostCurrent._mcl.getmd_black_1000()).Icon((android.graphics.drawable.Drawable)(_ico.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(_dcont.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).PositiveText(BA.ObjectToCharSequence("Start")).PositiveColor(mostCurrent._mcl.getmd_amber_700()).NeutralText(BA.ObjectToCharSequence("Cancel")).NeutralColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 487;BA.debugLine="deldia=Builder.Show";
mostCurrent._deldia = _builder.Show();
 //BA.debugLineNum = 488;BA.debugLine="deldia.Show";
mostCurrent._deldia.Show();
...
_pak = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim time,date As String";
_time = "";
_date = "";
 //BA.debugLineNum = 25;BA.debugLine="Dim dex As Timer";
_dex = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 26;BA.debugLine="Dim ex As Timer";
_ex = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 27;BA.debugLine="Dim exa As Timer";
_exa = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 28;BA.debugLine="Dim zipex As Timer";
_zipex = new anywheresoftware.b4a.objects.Timer();
...
String _ss = "";
int _sum = 0;
 //BA.debugLineNum = 1246;BA.debugLine="Sub prog_start";
 //BA.debugLineNum = 1247;BA.debugLine="Dim  version As String";
_version = "";
 //BA.debugLineNum = 1248;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1249;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 1250;BA.debugLine="Dim sum As Int";
_sum = 0;
 //BA.debugLineNum = 1251;BA.debugLine="sum=0";
_sum = (int) (0);
 //BA.debugLineNum = 1252;BA.debugLine="dir=datas.Getsimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1253;BA.debugLine="name1=pak.GetApplicationLabel(s)";
mostCurrent._name1 = _pak.GetApplicationLabel(_s);
 //BA.debugLineNum = 1254;BA.debugLine="icon=pak.GetApplicationIcon(s)";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pak.GetApplicationIcon(_s)));
 //BA.debugLineNum = 1256;BA.debugLine="version=pak.GetVersionName(s)";
_version = _pak.GetVersionName(_s);
 //BA.debugLineNum = 1257;BA.debugLine="If File.Exists(dir,name1&\"_\"&version&\".apk\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._dir,mostCurrent._name1+"_"+_version+".apk")) { 
 //BA.debugLineNum = 1259;BA.debugLine="ss=s";
_ss = _s;
 //BA.debugLineNum = 1260;BA.debugLine="dataliste.Clear";
mostCurrent._dataliste.Clear();
 //BA.debugLineNum = 1261;BA.debugLine="dataliste.AddTwoLinesAndBitmap(name1,FormatFileS";
mostCurrent._dataliste.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(mostCurrent._name1),BA.ObjectToCharSequence(_formatfilesize((float) (_size))),mostCurrent._icon.getBitmap());
 //BA.debugLineNum = 1262;BA.debugLine="dataliste.AddTwoLinesAndBitmap(\"Folder:\",datas.G";
mostCurrent._dataliste.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Folder:"),BA.ObjectToCharSequence(mostCurrent._datas._getsimple("0")),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_storage_white_18dp.png").getObject()));
 //BA.debugLineNum = 1263;BA.debugLine="dataliste.AddTwoLinesAndBitmap(\"Last:\",dtime.Get";
mostCurrent._dataliste.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Last:"),BA.ObjectToCharSequence(mostCurrent._dtime._getsimple(_ss)),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_storage_white_18dp.png").getObject()));
 //BA.debugLineNum = 1264;BA.debugLine="ex_pan";
_ex_pan();
 }else {
 //BA.debugLineNum = 1266;BA.debugLine="ex_pan2";
_ex_pan2();
 };
...
String _s = "";
 //BA.debugLineNum = 1198;BA.debugLine="Sub put_data";
 //BA.debugLineNum = 1199;BA.debugLine="Dim s As String = finish.Get(0)";
_s = BA.ObjectToString(mostCurrent._finish.Get((int) (0)));
 //BA.debugLineNum = 1200;BA.debugLine="packName=s";
mostCurrent._packname = _s;
 //BA.debugLineNum = 1201;BA.debugLine="If bcount.ContainsKey(packName) Then";
if (mostCurrent._bcount._containskey(mostCurrent._packname)) { 
 //BA.debugLineNum = 1202;BA.debugLine="dtime.Remove(packName)";
mostCurrent._dtime._remove(mostCurrent._packname);
 //BA.debugLineNum = 1203;BA.debugLine="dtime.PutSimple(packName,date&\" - \"&time)";
mostCurrent._dtime._putsimple(mostCurrent._packname,(Object)(_date+" - "+_time));
 //BA.debugLineNum = 1204;BA.debugLine="bcount.Remove(packName)";
mostCurrent._bcount._remove(mostCurrent._packname);
 //BA.debugLineNum = 1205;BA.debugLine="bcount.PutSimple(\"0\",packName)";
mostCurrent._bcount._putsimple("0",(Object)(mostCurrent._packname));
 }else {
 //BA.debugLineNum = 1207;BA.debugLine="dtime.PutSimple(packName,date&\" - \"&time)";
mostCurrent._dtime._putsimple(mostCurrent._packname,(Object)(_date+" - "+_time));
 //BA.debugLineNum = 1208;BA.debugLine="bcount.PutSimple(\"0\",packName)";
mostCurrent._bcount._putsimple("0",(Object)(mostCurrent._packname));
 };
...
Object _ob1 = null;
 //BA.debugLineNum = 1562;BA.debugLine="Sub put_pack( pname As String )";
 //BA.debugLineNum = 1563;BA.debugLine="Dim ob1 As Object";
_ob1 = new Object();
 //BA.debugLineNum = 1564;BA.debugLine="ob1=pname";
_ob1 = (Object)(_pname);
 //BA.debugLineNum = 1565;BA.debugLine="finish.Clear";
mostCurrent._finish.Clear();
 //BA.debugLineNum = 1566;BA.debugLine="finish.Add(pname)";
mostCurrent._finish.Add((Object)(_pname));
 //BA.debugLineNum = 1568;BA.debugLine="ab1_Click";
_ab1_click();
...
anywheresoftware.b4a.agraham.dialogs.InputDialog.CustomDialog2 _wl = null;
 //BA.debugLineNum = 356;BA.debugLine="Sub rvmenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 357;BA.debugLine="Select Position";
switch (_position) {
case 0: {
 //BA.debugLineNum = 359;BA.debugLine="app_share";
_app_share();
 break; }
case 1: {
 //BA.debugLineNum = 362;BA.debugLine="Dim url As String=\"http://sulomedia.de/index.ph";
_url = "http://sulomedia.de/index.php/2017/06/30/faq-and-help-page/";
 //BA.debugLineNum = 363;BA.debugLine="Dim wv As WebView";
_wv = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 364;BA.debugLine="wv.Initialize(\"wv\")";
_wv.Initialize(mostCurrent.activityBA,"wv");
 //BA.debugLineNum = 365;BA.debugLine="wv.JavaScriptEnabled=True";
_wv.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 366;BA.debugLine="wv.ZoomEnabled=True";
_wv.setZoomEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 367;BA.debugLine="Dim wl As CustomDialog2";
_wl = new anywheresoftware.b4a.agraham.dialogs.InputDialog.CustomDialog2();
 //BA.debugLineNum = 368;BA.debugLine="wl.AddView(wv,96%x,90%y)";
_wl.AddView((android.view.View)(_wv.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (96),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 370;BA.debugLine="wv.LoadUrl(url)";
_wv.LoadUrl(_url);
 //BA.debugLineNum = 371;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 //BA.debugLineNum = 372;BA.debugLine="wl.Show(\"FAQ/Help Page\",\"reload\",\"\",\"close\",Loa";
_wl.Show("FAQ/Help Page","reload","","close",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_turned_in_white_36dp.png").getObject()));
 //BA.debugLineNum = 374;BA.debugLine="If Not(wl.Response=DialogResponse.NEGATIVE) The";
if (anywheresoftware.b4a.keywords.Common.Not(_wl.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.NEGATIVE)) { 
 //BA.debugLineNum = 375;BA.debugLine="wv.LoadUrl(url)";
_wv.LoadUrl(_url);
 //BA.debugLineNum = 376;BA.debugLine="wl.Show(\"FAQ/Help Page\",\"reload\",\"\",\"close\",Lo";
_wl.Show("FAQ/Help Page","reload","","close",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_assignment_turned_in_white_36dp.png").getObject()));
 }else {
 //BA.debugLineNum = 378;BA.debugLine="ToastMessageShow(\"closed\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("closed"),anywheresoftware.b4a.keywords.Common.False);
 };
 break; }
case 2: {
 //BA.debugLineNum = 381;BA.debugLine="CallSub(Me,dev_info)";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,main.getObject(),_dev_info());
 //BA.debugLineNum = 382;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 break; }
}
;
...
public static String  _social_init() throws Exception{
 //BA.debugLineNum = 747;BA.debugLine="Sub social_init";
 //BA.debugLineNum = 748;BA.debugLine="ToastMessageShow(\"avaiable at next update..\",Fals";
...
public static String  _stadia_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,String _action) throws Exception{
 //BA.debugLineNum = 890;BA.debugLine="Sub stadia_ButtonPressed (Dialog As MaterialDialog";
 //BA.debugLineNum = 891;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_dialog.ACTION_POSITIVE,_dialog.ACTION_NEGATIVE,_dialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 893;BA.debugLine="prog_start";
_prog_start();
 break; }
case 1: {
 //BA.debugLineNum = 895;BA.debugLine="ToastMessageShow(Action, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 897;BA.debugLine="ToastMessageShow(Action&\"...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_action+"..."),anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
...
public static String  _stadia_itemselected(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,int _position,String _text) throws Exception{
 //BA.debugLineNum = 878;BA.debugLine="Sub stadia_ItemSelected (Dialog As MaterialDialog,";
 //BA.debugLineNum = 879;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 880;BA.debugLine="path_explorer";
_path_explorer();
 }else {
 //BA.debugLineNum = 882;BA.debugLine="prog_start";
_prog_start();
 };
...
public static String  _stadia_singlechoiceitemselected(de.amberhome.materialdialogs.MaterialDialogWrapper _dialog,int _position,String _text) throws Exception{
 //BA.debugLineNum = 885;BA.debugLine="Sub stadia_SingleChoiceItemSelected (Dialog As Mat";
 //BA.debugLineNum = 886;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 887;BA.debugLine="path_explorer";
_path_explorer();
 };
...
double _h = 0;
 //BA.debugLineNum = 1550;BA.debugLine="Sub TextToBitmap (s As String, FontSize As Float)";
 //BA.debugLineNum = 1551;BA.debugLine="Dim lblfont As Label";
_lblfont = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1552;BA.debugLine="lblfont.Initialize(\"\")";
_lblfont.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1553;BA.debugLine="lblfont.Text=s";
_lblfont.setText(BA.ObjectToCharSequence(_s));
 //BA.debugLineNum = 1554;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 1555;BA.debugLine="bmp.InitializeMutable(32dip, 32dip)";
_bmp.InitializeMutable(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)));
 //BA.debugLineNum = 1556;BA.debugLine="Dim cvs As Canvas";
_cvs = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 1557;BA.debugLine="cvs.Initialize2(bmp)";
_cvs.Initialize2((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 1558;BA.debugLine="Dim h As Double = cvs.MeasureStringHeight(s, lblf";
_h = _cvs.MeasureStringHeight(_s,_lblfont.getTypeface(),_fontsize);
 //BA.debugLineNum = 1559;BA.debugLine="cvs.DrawText(s, bmp.Width / 2, bmp.Height / 2 + h";
_cvs.DrawText(mostCurrent.activityBA,_s,(float) (_bmp.getWidth()/(double)2),(float) (_bmp.getHeight()/(double)2+_h/(double)2),_lblfont.getTypeface(),_fontsize,anywheresoftware.b4a.keywords.Common.Colors.White,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 1560;BA.debugLine="Return bmp";
if (true) return _bmp;
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Sub toolbar_MenuItemClick (Item As ACMenuItem)";
...
case 0: {
 //BA.debugLineNum = 429;BA.debugLine="sm.ShowMenu";
mostCurrent._sm.ShowMenu();
 break; }
case 1: {
 //BA.debugLineNum = 431;BA.debugLine="sm.ShowSecondaryMenu";
mostCurrent._sm.ShowSecondaryMenu();
 break; }
case 2: {
 //BA.debugLineNum = 433;BA.debugLine="close_click";
_close_click();
 break; }
case 3: {
 break; }
...
public static String  _toolbar_navigationitemclick() throws Exception{
 //BA.debugLineNum = 412;BA.debugLine="Sub toolbar_NavigationItemClick";
 //BA.debugLineNum = 413;BA.debugLine="If sm.Visible=True Then";
if (mostCurrent._sm.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 414;BA.debugLine="sm.HideMenus";
mostCurrent._sm.HideMenus();
 }else {
 //BA.debugLineNum = 416;BA.debugLine="sm.ShowMenu";
mostCurrent._sm.ShowMenu();
 };
...
public static boolean  _wv_overrideurl(String _url) throws Exception{
 //BA.debugLineNum = 390;BA.debugLine="Sub wv_OverrideUrl (Url As String) As Boolean";
 //BA.debugLineNum = 391;BA.debugLine="If Url=Url Then";
if ((_url).equals(_url)) { 
 //BA.debugLineNum = 392;BA.debugLine="ProgressDialogShow(\"loading..\")";
...
public static String  _wv_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 387;BA.debugLine="Sub wv_PageFinished (Url As String)";
 //BA.debugLineNum = 388;BA.debugLine="ToastMessageShow(\"Page 100% loaded\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Page 100% loaded"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 389;BA.debugLine="End Sub";
return "";
}
public static String  _zip_ex() throws Exception{
com.AB.ABZipUnzip.ABZipUnzip _zip = null;
com.AB.ABZipUnzip.ABZipUnzip.ABZipContent _zipc = null;
anywheresoftware.b4a.objects.collections.List _dlist = null;
int _i = 0;
 //BA.debugLineNum = 1017;BA.debugLine="Sub zip_ex";
 //BA.debugLineNum = 1018;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 1019;BA.debugLine="Dim zip As ABZipUnzip";
_zip = new com.AB.ABZipUnzip.ABZipUnzip();
 //BA.debugLineNum = 1020;BA.debugLine="Dim zipc As ABZipContent";
_zipc = new com.AB.ABZipUnzip.ABZipUnzip.ABZipContent();
 //BA.debugLineNum = 1021;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1022;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 1023;BA.debugLine="dlist.Clear";
_dlist.Clear();
 //BA.debugLineNum = 1024;BA.debugLine="dlist=File.ListFiles(dir)";
_dlist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._dir);
 //BA.debugLineNum = 1025;BA.debugLine="For i = 0 To dlist.Size-1";
{
final int step8 = 1;
final int limit8 = (int) (_dlist.getSize()-1);
_i = (int) (0) ;
for (;(step8 > 0 && _i <= limit8) || (step8 < 0 && _i >= limit8) ;_i = ((int)(0 + _i + step8))  ) {
 //BA.debugLineNum = 1026;BA.debugLine="Log(\"ziping..\")";
anywheresoftware.b4a.keywords.Common.Log("ziping..");
 //BA.debugLineNum = 1027;BA.debugLine="zip.ABZipDirectory(File.DirRootExternal&\"APEX\",F";
_zip.ABZipDirectory(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"APEX",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+_date+"_"+_time+"_backup_archive.zip");
 }
};
 //BA.debugLineNum = 1030;BA.debugLine="End Sub";
return "";
}
public static String  _zip_pan() throws Exception{
anywheresoftware.b4a.objects.collections.List _dlist = null;
int _a1 = 0;
int _sum = 0;
de.amberhome.materialdialogs.MaterialDialogBuilderWrapper _builder = null;
int _g = 0;
 //BA.debugLineNum = 975;BA.debugLine="Sub zip_pan";
 //BA.debugLineNum = 976;BA.debugLine="Dim dlist As List";
_dlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 977;BA.debugLine="dlist.Initialize";
_dlist.Initialize();
 //BA.debugLineNum = 978;BA.debugLine="dir=datas.GetSimple(\"0\")";
mostCurrent._dir = mostCurrent._datas._getsimple("0");
 //BA.debugLineNum = 979;BA.debugLine="Dim a1,sum As Int";
_a1 = 0;
_sum = 0;
 //BA.debugLineNum = 980;BA.debugLine="Label4.Text=\"compressing backup-archive to zip-ar";
mostCurrent._label4.setText(BA.ObjectToCharSequence("compressing backup-archive to zip-archive"));
 //BA.debugLineNum = 981;BA.debugLine="Label4.TextColor=mcl.md_black_1000";
mostCurrent._label4.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 982;BA.debugLine="Label4.TextSize=12";
mostCurrent._label4.setTextSize((float) (12));
 //BA.debugLineNum = 983;BA.debugLine="Label4.Gravity=Gravity.FILL";
mostCurrent._label4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 984;BA.debugLine="Label4.Typeface=superfont";
mostCurrent._label4.setTypeface((android.graphics.Typeface)(mostCurrent._superfont.getObject()));
 //BA.debugLineNum = 985;BA.debugLine="Dim Builder As MaterialDialogBuilder";
_builder = new de.amberhome.materialdialogs.MaterialDialogBuilderWrapper();
 //BA.debugLineNum = 986;BA.debugLine="Builder.Initialize(\"Dialog\")";
_builder.Initialize(mostCurrent.activityBA,"Dialog");
 //BA.debugLineNum = 987;BA.debugLine="Builder.Title(\"export -> ZiP\").TitleColor(mcl.md_";
_builder.Title(BA.ObjectToCharSequence("export -> ZiP")).TitleColor(mostCurrent._mcl.getmd_blue_A400()).Icon((android.graphics.drawable.Drawable)(mostCurrent._icon.getObject())).LimitIconToDefaultSize().Theme(_builder.THEME_LIGHT).Content(BA.ObjectToCharSequence(mostCurrent._label4.getText())).ContentLineSpacing((float) (1)).ContentColor(mostCurrent._mcl.getmd_black_1000()).Cancelable(anywheresoftware.b4a.keywords.Common.False).AutoDismiss(anywheresoftware.b4a.keywords.Common.True).Build();
 //BA.debugLineNum = 988;BA.debugLine="For g = 0 To dlist.Size-1";
{
final int step13 = 1;
final int limit13 = (int) (_dlist.getSize()-1);
_g = (int) (0) ;
for (;(step13 > 0 && _g <= limit13) || (step13 < 0 && _g >= limit13) ;_g = ((int)(0 + _g + step13))  ) {
 //BA.debugLineNum = 989;BA.debugLine="a1=File.Size(dir,dlist.Get(g))";
_a1 = (int) (anywheresoftware.b4a.keywords.Common.File.Size(mostCurrent._dir,BA.ObjectToString(_dlist.Get(_g))));
 //BA.debugLineNum = 990;BA.debugLine="Log(a1)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_a1));
 }
};
 //BA.debugLineNum = 992;BA.debugLine="sum=a1*1024*10";
_sum = (int) (_a1*1024*10);
 //BA.debugLineNum = 993;BA.debugLine="Builder.progress2(False,sum,True)";
_builder.Progress2(anywheresoftware.b4a.keywords.Common.False,_sum,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 994;BA.debugLine="pdia=Builder.Show";
mostCurrent._pdia = _builder.Show();
 //BA.debugLineNum = 995;BA.debugLine="pdia.Show";
mostCurrent._pdia.Show();
 //BA.debugLineNum = 996;BA.debugLine="zipex.Enabled=True";
_zipex.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 997;BA.debugLine="End Sub";
return "";
}
public static String  _zipex_tick() throws Exception{
 //BA.debugLineNum = 999;BA.debugLine="Sub zipex_Tick";
 //BA.debugLineNum = 1001;BA.debugLine="If Not(pdia.IsShowing) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._pdia.IsShowing())) { 
 //BA.debugLineNum = 1002;BA.debugLine="exa.Enabled = False";
_exa.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1003;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 1005;BA.debugLine="If pdia.CurrentProgress= pdia.MaxProgress-1 Then";
if (mostCurrent._pdia.getCurrentProgress()==mostCurrent._pdia.getMaxProgress()-1) { 
_zip_ex();};
 //BA.debugLineNum = 1006;BA.debugLine="If pdia.CurrentProgress = pdia.MaxProgress Then";
if (mostCurrent._pdia.getCurrentProgress()==mostCurrent._pdia.getMaxProgress()) { 
 //BA.debugLineNum = 1007;BA.debugLine="zipex.Enabled = False";
_zipex.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1008;BA.debugLine="pdia.Content = \"Done! Zip-file saved to: \"&dir";
mostCurrent._pdia.setContent(BA.ObjectToCharSequence("Done! Zip-file saved to: "+mostCurrent._dir));
 //BA.debugLineNum = 1012;BA.debugLine="pdia.Dismiss";
mostCurrent._pdia.Dismiss();
 }else {
 //BA.debugLineNum = 1014;BA.debugLine="pdia.IncrementProgress(1)";
mostCurrent._pdia.IncrementProgress((int) (1));
 };
