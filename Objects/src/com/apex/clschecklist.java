...
public class clschecklist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.apex.clschecklist");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.apex.clschecklist.class).invoke(this, new Object[] {null});
        else
...
int _i = 0;
com.apex.clschecklist._typsortdata _sortdata = null;
int _firsttosort = 0;
int _lasttosort = 0;
...
_sortdata = new com.apex.clschecklist._typsortdata();
...
_sortdata = (com.apex.clschecklist._typsortdata)(_sortlist.Get((int) (_i-_firstposition)));
