...
public class clsexplorer extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.apex.clsexplorer");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.apex.clsexplorer.class).invoke(this, new Object[] {null});
        else
...
public com.apex.clsexplorer._typresult _selection = null;
...
public com.apex.clschecklist _lstfichiers = null;
...
_selection = new com.apex.clsexplorer._typresult();
...
_lstfichiers = new com.apex.clschecklist();
