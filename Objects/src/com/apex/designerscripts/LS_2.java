...
//BA.debugLineNum = 5;BA.debugLine="ListView1.SetTopAndBottom(13%y,100%y)"[2/General script]
views.get("listview1").vw.setTop((int)((13d / 100 * height)));
views.get("listview1").vw.setHeight((int)((100d / 100 * height) - ((13d / 100 * height))));
//BA.debugLineNum = 6;BA.debugLine="ListView1.SetLeftAndRight(0dip,100%x)"[2/General script]
...
//BA.debugLineNum = 9;BA.debugLine="iv1.SetLeftAndRight(0dip,25%x)"[2/General script]
views.get("iv1").vw.setLeft((int)((0d * scale)));
views.get("iv1").vw.setWidth((int)((25d / 100 * width) - ((0d * scale))));
//BA.debugLineNum = 10;BA.debugLine="iv1.Top=30dip"[2/General script]
views.get("iv1").vw.setTop((int)((30d * scale)));
